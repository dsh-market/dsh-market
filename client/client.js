window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		function fieldRelevance(value, query, tokens, weight) {
			if (!value) return 0;
		...
		*/
		function pluginRelevance(plugin, query, tokens, lang, categories) {
			...
			return Math.max(fieldRelevance(plugin.name, query, tokens, 700), fieldRelevance(plugin.npm, query, tokens, 700), fieldRelevance(plugin.owner, query, tokens, 400), fieldRelevance(preferredDescription, query, tokens, 280), ...otherDescriptions.map((value) => fieldRelevance(value, query, tokens, 240)), ...categoryIds.map((value) => fieldRelevance(value, query, tokens, 180)), ...categoryLabels.map((value) => fieldRelevance(value, query, tokens, 180)));
		}
		...
		*/
		...
		const css = ".OIF0DG_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.OIF0DG_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.OIF0DG_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.OIF0DG_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.OIF0DG_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.OIF0DG_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.OIF0DG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.OIF0DG_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.OIF0DG_tab.OIF0DG_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.OIF0DG_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.OIF0DG_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.OIF0DG_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.OIF0DG_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.OIF0DG_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.OIF0DG_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.OIF0DG_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.OIF0DG_cats{margin:0 -4px 2px;padding:12px 4px 4px}.OIF0DG_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.OIF0DG_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.OIF0DG_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.OIF0DG_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.OIF0DG_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.OIF0DG_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.OIF0DG_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.OIF0DG_catsCollapsed{max-height:62px;overflow:hidden}.OIF0DG_catsToggle.OIF0DG_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.OIF0DG_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.OIF0DG_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.OIF0DG_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.OIF0DG_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.OIF0DG_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.OIF0DG_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.OIF0DG_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.OIF0DG_lightboxClose:hover{background:#ffffff38}.OIF0DG_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.OIF0DG_lightboxNav:hover{background:#ffffff38}.OIF0DG_lightboxPrev{left:16px}.OIF0DG_lightboxNext{right:16px}.OIF0DG_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.OIF0DG_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.OIF0DG_lightboxDotOn{background:#fff}.OIF0DG_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.OIF0DG_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.OIF0DG_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.OIF0DG_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.OIF0DG_masonry{align-items:flex-start;gap:10px;display:flex}.OIF0DG_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.OIF0DG_masonry>.OIF0DG_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.OIF0DG_masonry{flex-direction:column}.OIF0DG_masonryCol{width:100%}.OIF0DG_grid{grid-template-columns:minmax(0,1fr)}}.OIF0DG_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.OIF0DG_themesGrid{margin-bottom:12px}.OIF0DG_swatches i{flex:1}.OIF0DG_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.OIF0DG_themeSearch{box-sizing:border-box;width:100%;min-width:0}.OIF0DG_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.OIF0DG_themeFullscreenBtn.OIF0DG_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.OIF0DG_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.OIF0DG_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.OIF0DG_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.OIF0DG_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.OIF0DG_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.OIF0DG_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.OIF0DG_themeCover:hover img{transform:scale(1.012)}.OIF0DG_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.OIF0DG_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.OIF0DG_themePreviewAction,.OIF0DG_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.OIF0DG_themePreviewAction{gap:4px;right:8px}.OIF0DG_themePreviewCount{left:8px}.OIF0DG_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.OIF0DG_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.OIF0DG_themeIdentity{flex:1;min-width:0}.OIF0DG_themeStatus,.OIF0DG_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.OIF0DG_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.OIF0DG_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.OIF0DG_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.OIF0DG_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.OIF0DG_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.OIF0DG_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.OIF0DG_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.OIF0DG_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.OIF0DG_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.OIF0DG_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.OIF0DG_sub>span:first-child{grid-area:1/1}.OIF0DG_sub>.OIF0DG_grow{display:none}.OIF0DG_submitLink{grid-area:2/1}.OIF0DG_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.OIF0DG_themeToolbar{grid-template-columns:minmax(0,1fr)}.OIF0DG_themeCardHead{flex-wrap:wrap}.OIF0DG_themeStatus,.OIF0DG_themeStatusMuted{order:3}}@container (width<=280px){.OIF0DG_themeCardFooter{flex-direction:column;align-items:flex-start}.OIF0DG_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.OIF0DG_themeCard,.OIF0DG_themeCover img{transition:none}.OIF0DG_themeCard:hover{transform:none}}.OIF0DG_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.OIF0DG_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.OIF0DG_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.OIF0DG_installBtn.OIF0DG_installBtn{min-width:64px}.OIF0DG_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.OIF0DG_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.OIF0DG_nmLink{color:inherit;text-decoration:none;display:block}.OIF0DG_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.OIF0DG_repoMark{color:var(--dsw-alias-label-tertiary,#8b93a1);vertical-align:-1px;flex-shrink:0;margin-left:5px}.OIF0DG_nmLink:hover .OIF0DG_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.OIF0DG_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.OIF0DG_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.OIF0DG_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.OIF0DG_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.OIF0DG_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.OIF0DG_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.OIF0DG_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.OIF0DG_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.OIF0DG_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.OIF0DG_foot .OIF0DG_metaInline,.OIF0DG_foot .OIF0DG_src{white-space:nowrap}.OIF0DG_grow{flex:1}.OIF0DG_titleRow{align-items:center;gap:10px;display:flex}.OIF0DG_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.OIF0DG_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.OIF0DG_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.OIF0DG_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.OIF0DG_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.OIF0DG_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.OIF0DG_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.OIF0DG_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.OIF0DG_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.OIF0DG_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.OIF0DG_noteInput{flex:1;min-width:160px}.OIF0DG_descTight{min-height:0}.OIF0DG_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.OIF0DG_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.OIF0DG_dot{vertical-align:2px;margin-left:5px}.OIF0DG_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.OIF0DG_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.OIF0DG_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.OIF0DG_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.OIF0DG_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.OIF0DG_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.OIF0DG_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite OIF0DG_sp;display:inline-flex}.OIF0DG_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.OIF0DG_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite OIF0DG_dshmPlug}@keyframes OIF0DG_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.OIF0DG_logoPlug,.OIF0DG_spin{animation:1.5s ease-in-out infinite OIF0DG_dshmPlugFade}}@keyframes OIF0DG_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes OIF0DG_sp{to{transform:rotate(360deg)}}.OIF0DG_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.OIF0DG_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.OIF0DG_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.OIF0DG_barWave{width:30%;animation:1.2s ease-in-out infinite OIF0DG_dshmSlide}@keyframes OIF0DG_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.OIF0DG_irow .OIF0DG_progress{margin-top:8px}.OIF0DG_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.OIF0DG_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.OIF0DG_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.OIF0DG_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.OIF0DG_conflictHead{align-items:flex-start;gap:8px;display:flex}.OIF0DG_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.OIF0DG_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.OIF0DG_conflictBody{margin:0;font-size:12px;line-height:19px}.OIF0DG_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.OIF0DG_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.OIF0DG_rosterMain{flex-direction:column;min-width:0;display:flex}.OIF0DG_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.OIF0DG_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.OIF0DG_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.OIF0DG_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.OIF0DG_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.OIF0DG_rosterRowOut .OIF0DG_rosterName{text-decoration:line-through}.OIF0DG_rosterRowOut{opacity:.62}.OIF0DG_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.OIF0DG_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.OIF0DG_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.OIF0DG_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.OIF0DG_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.OIF0DG_choices{flex-direction:column;gap:7px;display:flex}.OIF0DG_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.OIF0DG_choice:has(input:disabled){cursor:default;opacity:.6}.OIF0DG_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.OIF0DG_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.OIF0DG_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.OIF0DG_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.OIF0DG_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.OIF0DG_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.OIF0DG_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.OIF0DG_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.OIF0DG_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.OIF0DG_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.OIF0DG_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.OIF0DG_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.OIF0DG_nameLink{color:inherit;text-decoration:none}.OIF0DG_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.OIF0DG_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.OIF0DG_irowName>.OIF0DG_owner{flex:none}.OIF0DG_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.OIF0DG_opWrap{flex-shrink:0;display:inline-flex;position:relative}.OIF0DG_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.OIF0DG_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.OIF0DG_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.OIF0DG_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.OIF0DG_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.OIF0DG_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.OIF0DG_opPanelTitle{font-size:12.5px;font-weight:600}.OIF0DG_opCloseBtn.OIF0DG_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.OIF0DG_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.OIF0DG_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.OIF0DG_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.OIF0DG_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.OIF0DG_opRow:last-child{border-bottom:none}.OIF0DG_opRowAlert{background:#dc26260f}.OIF0DG_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.OIF0DG_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.OIF0DG_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.OIF0DG_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.OIF0DG_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.OIF0DG_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.OIF0DG_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.OIF0DG_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.OIF0DG_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.OIF0DG_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.OIF0DG_opDecisionFoot{align-items:center;gap:8px;display:flex}.OIF0DG_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.OIF0DG_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.OIF0DG_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.OIF0DG_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.OIF0DG_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.OIF0DG_dangerBtn.OIF0DG_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.OIF0DG_dangerBtn.OIF0DG_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.OIF0DG_dangerArmed.OIF0DG_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.OIF0DG_retryBtn{margin-top:4px}.OIF0DG_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.OIF0DG_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.OIF0DG_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.OIF0DG_irowMissing{filter:grayscale();opacity:.5}.OIF0DG_irow>.OIF0DG_src,.OIF0DG_irow>.OIF0DG_owner,.OIF0DG_irow button{white-space:nowrap;flex-shrink:0}.OIF0DG_tabSearchRow{padding:0 4px 6px;display:flex}.OIF0DG_tabSearch{width:100%}.OIF0DG_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.OIF0DG_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.OIF0DG_specTagGit{color:#0b7285;background:#12a3c41f}.OIF0DG_specTagFile{color:#b07d1b;background:#f0b42924}.OIF0DG_backupCheckList .OIF0DG_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.OIF0DG_backupCheckList .OIF0DG_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.OIF0DG_staleAction{margin-top:8px}.OIF0DG_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.OIF0DG_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.OIF0DG_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.OIF0DG_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.OIF0DG_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.OIF0DG_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.OIF0DG_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.OIF0DG_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.OIF0DG_deprecate .OIF0DG_src{margin-left:8px}.OIF0DG_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.OIF0DG_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.OIF0DG_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.OIF0DG_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.OIF0DG_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.OIF0DG_switchOn .OIF0DG_switchKnob,.OIF0DG_switchMixed .OIF0DG_switchKnob{left:18px}.OIF0DG_switch:disabled{opacity:.5;cursor:default}.OIF0DG_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.OIF0DG_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.OIF0DG_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.OIF0DG_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.OIF0DG_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.OIF0DG_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.OIF0DG_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.OIF0DG_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.OIF0DG_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.OIF0DG_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.OIF0DG_groupMember .OIF0DG_nm{flex:1;min-width:0;font-size:12px}.OIF0DG_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.OIF0DG_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.OIF0DG_inlineInput{flex:1;min-width:120px}.OIF0DG_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.OIF0DG_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.OIF0DG_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.OIF0DG_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.OIF0DG_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.OIF0DG_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.OIF0DG_backupCard h3{margin:0;font-size:14px}.OIF0DG_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.OIF0DG_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.OIF0DG_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.OIF0DG_backupInput{box-sizing:border-box;width:100%}.OIF0DG_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.OIF0DG_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.OIF0DG_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.OIF0DG_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.OIF0DG_backupCheckList .OIF0DG_backupCheck{justify-content:space-between;gap:8px}.OIF0DG_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.OIF0DG_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.OIF0DG_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.OIF0DG_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.OIF0DG_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.OIF0DG_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.OIF0DG_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.OIF0DG_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.OIF0DG_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.OIF0DG_diagBundle:first-of-type{border-top:none;padding-top:0}.OIF0DG_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.OIF0DG_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.OIF0DG_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.OIF0DG_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.OIF0DG_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.OIF0DG_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.OIF0DG_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.OIF0DG_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.OIF0DG_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.OIF0DG_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.OIF0DG_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.OIF0DG_diagList{flex-direction:column;gap:6px;display:flex}.OIF0DG_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.OIF0DG_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.OIF0DG_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.OIF0DG_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.OIF0DG_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.OIF0DG_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.OIF0DG_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.OIF0DG_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.OIF0DG_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.OIF0DG_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.OIF0DG_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.OIF0DG_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.OIF0DG_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.OIF0DG_collapseTitle{flex:1;min-width:0}.OIF0DG_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.OIF0DG_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.OIF0DG_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.OIF0DG_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.OIF0DG_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.OIF0DG_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.OIF0DG_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.OIF0DG_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.OIF0DG_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.OIF0DG_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.OIF0DG_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.OIF0DG_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.OIF0DG_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.OIF0DG_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.OIF0DG_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.OIF0DG_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.OIF0DG_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.OIF0DG_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.OIF0DG_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.OIF0DG_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.OIF0DG_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.OIF0DG_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.OIF0DG_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.OIF0DG_setChevronOpen{transform:rotate(180deg)}.OIF0DG_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.OIF0DG_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.OIF0DG_setRow+.OIF0DG_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.OIF0DG_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.OIF0DG_setLabel{font-size:13px;line-height:20px}.OIF0DG_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.OIF0DG_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.OIF0DG_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.OIF0DG_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.OIF0DG_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.OIF0DG_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.OIF0DG_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.OIF0DG_setSegBtn:disabled{cursor:default;opacity:.5}.OIF0DG_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.OIF0DG_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.OIF0DG_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}.OIF0DG_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.OIF0DG_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}.OIF0DG_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}.OIF0DG_commentsStatus:empty{display:none}.OIF0DG_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}.OIF0DG_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}.OIF0DG_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}.OIF0DG_commentsMount iframe{width:100%}.OIF0DG_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}.OIF0DG_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}.OIF0DG_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}.OIF0DG_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}.OIF0DG_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}.OIF0DG_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}.OIF0DG_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.OIF0DG_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}.OIF0DG_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}.OIF0DG_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}.OIF0DG_notesP{font-size:13px;line-height:20px}.OIF0DG_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}.OIF0DG_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}.OIF0DG_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}.OIF0DG_notesRow:last-child{border-bottom:none}.OIF0DG_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}.OIF0DG_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}.OIF0DG_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}.OIF0DG_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}.OIF0DG_notesVer{color:inherit;font-weight:600;text-decoration:none}.OIF0DG_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "OIF0DG_act",
			"actBroken": "OIF0DG_actBroken",
			"actLive": "OIF0DG_actLive",
			"actWarn": "OIF0DG_actWarn",
			"actWhy": "OIF0DG_actWhy",
			"assignRow": "OIF0DG_assignRow",
			"assignSelect": "OIF0DG_assignSelect",
			"av": "OIF0DG_av",
			"backupActions": "OIF0DG_backupActions",
			"backupCard": "OIF0DG_backupCard",
			"backupCheck": "OIF0DG_backupCheck",
			"backupCheckList": "OIF0DG_backupCheckList",
			"backupGrid": "OIF0DG_backupGrid",
			"backupInput": "OIF0DG_backupInput",
			"backupMessage": "OIF0DG_backupMessage",
			"backupWarn": "OIF0DG_backupWarn",
			"banner": "OIF0DG_banner",
			"bannerHint": "OIF0DG_bannerHint",
			"bannerIcon": "OIF0DG_bannerIcon",
			"bar": "OIF0DG_bar",
			"barFill": "OIF0DG_barFill",
			"barWave": "OIF0DG_barWave",
			"body": "OIF0DG_body",
			"byline": "OIF0DG_byline",
			"card": "OIF0DG_card",
			"cardAction": "OIF0DG_cardAction",
			"cardBlocked": "OIF0DG_cardBlocked",
			"cardBlockedMark": "OIF0DG_cardBlockedMark",
			"cardShot": "OIF0DG_cardShot",
			"cardShots": "OIF0DG_cardShots",
			"cats": "OIF0DG_cats",
			"catsCollapsed": "OIF0DG_catsCollapsed",
			"catsRow": "OIF0DG_catsRow",
			"catsToggle": "OIF0DG_catsToggle",
			"catsWrap": "OIF0DG_catsWrap",
			"choice": "OIF0DG_choice",
			"choiceMain": "OIF0DG_choiceMain",
			"choiceNote": "OIF0DG_choiceNote",
			"choiceOn": "OIF0DG_choiceOn",
			"choiceRadio": "OIF0DG_choiceRadio",
			"choices": "OIF0DG_choices",
			"choiceSafe": "OIF0DG_choiceSafe",
			"choiceTitle": "OIF0DG_choiceTitle",
			"cmd": "OIF0DG_cmd",
			"collapseBody": "OIF0DG_collapseBody",
			"collapseHead": "OIF0DG_collapseHead",
			"collapseIcon": "OIF0DG_collapseIcon",
			"collapseTitle": "OIF0DG_collapseTitle",
			"commentsError": "OIF0DG_commentsError",
			"commentsFail": "OIF0DG_commentsFail",
			"commentsLink": "OIF0DG_commentsLink",
			"commentsMount": "OIF0DG_commentsMount",
			"commentsNote": "OIF0DG_commentsNote",
			"commentsStatus": "OIF0DG_commentsStatus",
			"confirmRow": "OIF0DG_confirmRow",
			"conflictBody": "OIF0DG_conflictBody",
			"conflictDetailsToggle": "OIF0DG_conflictDetailsToggle",
			"conflictHead": "OIF0DG_conflictHead",
			"conflictIcon": "OIF0DG_conflictIcon",
			"conflictTitle": "OIF0DG_conflictTitle",
			"conflictWhy": "OIF0DG_conflictWhy",
			"conflictWhyText": "OIF0DG_conflictWhyText",
			"dangerArmed": "OIF0DG_dangerArmed",
			"dangerBtn": "OIF0DG_dangerBtn",
			"depBadge": "OIF0DG_depBadge",
			"depLine": "OIF0DG_depLine",
			"deprecate": "OIF0DG_deprecate",
			"desc": "OIF0DG_desc",
			"descClamp": "OIF0DG_descClamp",
			"descTight": "OIF0DG_descTight",
			"descToggle": "OIF0DG_descToggle",
			"diagAlert": "OIF0DG_diagAlert",
			"diagArrow": "OIF0DG_diagArrow",
			"diagBadgeCommunity": "OIF0DG_diagBadgeCommunity",
			"diagBadgeInfo": "OIF0DG_diagBadgeInfo",
			"diagBadgeOfficial": "OIF0DG_diagBadgeOfficial",
			"diagBadgeShadow": "OIF0DG_diagBadgeShadow",
			"diagBadgeWarn": "OIF0DG_diagBadgeWarn",
			"diagBundle": "OIF0DG_diagBundle",
			"diagCount": "OIF0DG_diagCount",
			"diagEmpty": "OIF0DG_diagEmpty",
			"diagIndex": "OIF0DG_diagIndex",
			"diagKey": "OIF0DG_diagKey",
			"diagList": "OIF0DG_diagList",
			"diagMeta": "OIF0DG_diagMeta",
			"diagPage": "OIF0DG_diagPage",
			"diagRow": "OIF0DG_diagRow",
			"diagSection": "OIF0DG_diagSection",
			"diagSummary": "OIF0DG_diagSummary",
			"diagSummaryItem": "OIF0DG_diagSummaryItem",
			"diagSummaryMeta": "OIF0DG_diagSummaryMeta",
			"diagVal": "OIF0DG_diagVal",
			"dot": "OIF0DG_dot",
			"dragging": "OIF0DG_dragging",
			"dragHandle": "OIF0DG_dragHandle",
			"dragOver": "OIF0DG_dragOver",
			"dshmPlug": "OIF0DG_dshmPlug",
			"dshmPlugFade": "OIF0DG_dshmPlugFade",
			"dshmSlide": "OIF0DG_dshmSlide",
			"empty": "OIF0DG_empty",
			"err": "OIF0DG_err",
			"exportLogBtn": "OIF0DG_exportLogBtn",
			"fixFallback": "OIF0DG_fixFallback",
			"fixFallbackText": "OIF0DG_fixFallbackText",
			"foot": "OIF0DG_foot",
			"grid": "OIF0DG_grid",
			"groupActions": "OIF0DG_groupActions",
			"groupAddPanel": "OIF0DG_groupAddPanel",
			"groupCreate": "OIF0DG_groupCreate",
			"groupHead": "OIF0DG_groupHead",
			"groupHint": "OIF0DG_groupHint",
			"groupMember": "OIF0DG_groupMember",
			"groupMembers": "OIF0DG_groupMembers",
			"groupName": "OIF0DG_groupName",
			"groupRow": "OIF0DG_groupRow",
			"grow": "OIF0DG_grow",
			"head": "OIF0DG_head",
			"hiddenFile": "OIF0DG_hiddenFile",
			"inlineInput": "OIF0DG_inlineInput",
			"installBtn": "OIF0DG_installBtn",
			"irow": "OIF0DG_irow",
			"irowActions": "OIF0DG_irowActions",
			"irowMissing": "OIF0DG_irowMissing",
			"irowName": "OIF0DG_irowName",
			"irowNameText": "OIF0DG_irowNameText",
			"irowTrailing": "OIF0DG_irowTrailing",
			"lightbox": "OIF0DG_lightbox",
			"lightboxClose": "OIF0DG_lightboxClose",
			"lightboxDot": "OIF0DG_lightboxDot",
			"lightboxDotOn": "OIF0DG_lightboxDotOn",
			"lightboxDots": "OIF0DG_lightboxDots",
			"lightboxImg": "OIF0DG_lightboxImg",
			"lightboxNav": "OIF0DG_lightboxNav",
			"lightboxNext": "OIF0DG_lightboxNext",
			"lightboxPrev": "OIF0DG_lightboxPrev",
			"loading": "OIF0DG_loading",
			"logoMark": "OIF0DG_logoMark",
			"logoPlug": "OIF0DG_logoPlug",
			"masonry": "OIF0DG_masonry",
			"masonryCol": "OIF0DG_masonryCol",
			"meta": "OIF0DG_meta",
			"metaInline": "OIF0DG_metaInline",
			"metaTag": "OIF0DG_metaTag",
			"metaTagOk": "OIF0DG_metaTagOk",
			"modalNote": "OIF0DG_modalNote",
			"nameLink": "OIF0DG_nameLink",
			"nm": "OIF0DG_nm",
			"nmLink": "OIF0DG_nmLink",
			"noteAction": "OIF0DG_noteAction",
			"noteEdit": "OIF0DG_noteEdit",
			"noteInput": "OIF0DG_noteInput",
			"noteMine": "OIF0DG_noteMine",
			"noteRow": "OIF0DG_noteRow",
			"notesArrow": "OIF0DG_notesArrow",
			"notesBody": "OIF0DG_notesBody",
			"notesCode": "OIF0DG_notesCode",
			"notesDate": "OIF0DG_notesDate",
			"notesH": "OIF0DG_notesH",
			"notesLink": "OIF0DG_notesLink",
			"notesList": "OIF0DG_notesList",
			"notesMeta": "OIF0DG_notesMeta",
			"notesMsg": "OIF0DG_notesMsg",
			"notesP": "OIF0DG_notesP",
			"notesPre": "OIF0DG_notesPre",
			"notesRange": "OIF0DG_notesRange",
			"notesRendered": "OIF0DG_notesRendered",
			"notesRow": "OIF0DG_notesRow",
			"notesSha": "OIF0DG_notesSha",
			"notesVer": "OIF0DG_notesVer",
			"noteToggle": "OIF0DG_noteToggle",
			"okState": "OIF0DG_okState",
			"on": "OIF0DG_on",
			"opActions": "OIF0DG_opActions",
			"opAggregate": "OIF0DG_opAggregate",
			"opAggregateHint": "OIF0DG_opAggregateHint",
			"opAggregateTop": "OIF0DG_opAggregateTop",
			"opCloseBtn": "OIF0DG_opCloseBtn",
			"opDecision": "OIF0DG_opDecision",
			"opDecisionFoot": "OIF0DG_opDecisionFoot",
			"opDot": "OIF0DG_opDot",
			"opEmpty": "OIF0DG_opEmpty",
			"opEmptyHint": "OIF0DG_opEmptyHint",
			"opEntry": "OIF0DG_opEntry",
			"opEntryAlert": "OIF0DG_opEntryAlert",
			"opEntryQuiet": "OIF0DG_opEntryQuiet",
			"opHead": "OIF0DG_opHead",
			"opIcon": "OIF0DG_opIcon",
			"opMain": "OIF0DG_opMain",
			"opName": "OIF0DG_opName",
			"opPanel": "OIF0DG_opPanel",
			"opPanelTitle": "OIF0DG_opPanelTitle",
			"opQueuedIcon": "OIF0DG_opQueuedIcon",
			"opRow": "OIF0DG_opRow",
			"opRowAlert": "OIF0DG_opRowAlert",
			"opStatus": "OIF0DG_opStatus",
			"opStatusBad": "OIF0DG_opStatusBad",
			"opTop": "OIF0DG_opTop",
			"opVerb": "OIF0DG_opVerb",
			"opWrap": "OIF0DG_opWrap",
			"orderPanel": "OIF0DG_orderPanel",
			"orphBadge": "OIF0DG_orphBadge",
			"orphRow": "OIF0DG_orphRow",
			"ovArrow": "OIF0DG_ovArrow",
			"ovByTag": "OIF0DG_ovByTag",
			"ovFrom": "OIF0DG_ovFrom",
			"ovRow": "OIF0DG_ovRow",
			"owner": "OIF0DG_owner",
			"pageEllipsis": "OIF0DG_pageEllipsis",
			"pageInfo": "OIF0DG_pageInfo",
			"pager": "OIF0DG_pager",
			"pagerPages": "OIF0DG_pagerPages",
			"panelActions": "OIF0DG_panelActions",
			"panelNote": "OIF0DG_panelNote",
			"pct": "OIF0DG_pct",
			"presetList": "OIF0DG_presetList",
			"presetName": "OIF0DG_presetName",
			"presetRow": "OIF0DG_presetRow",
			"progress": "OIF0DG_progress",
			"reassure": "OIF0DG_reassure",
			"reassureOk": "OIF0DG_reassureOk",
			"repoLink": "OIF0DG_repoLink",
			"repoMark": "OIF0DG_repoMark",
			"retryBtn": "OIF0DG_retryBtn",
			"root": "OIF0DG_root",
			"roster": "OIF0DG_roster",
			"rosterAuthor": "OIF0DG_rosterAuthor",
			"rosterMain": "OIF0DG_rosterMain",
			"rosterName": "OIF0DG_rosterName",
			"rosterRow": "OIF0DG_rosterRow",
			"rosterRowOut": "OIF0DG_rosterRowOut",
			"rosterSplit": "OIF0DG_rosterSplit",
			"rosterTag": "OIF0DG_rosterTag",
			"rosterTagDrop": "OIF0DG_rosterTagDrop",
			"rosterTagKeep": "OIF0DG_rosterTagKeep",
			"row1": "OIF0DG_row1",
			"sectAction": "OIF0DG_sectAction",
			"sectionOverview": "OIF0DG_sectionOverview",
			"setActions": "OIF0DG_setActions",
			"setBetaTag": "OIF0DG_setBetaTag",
			"setBody": "OIF0DG_setBody",
			"setCard": "OIF0DG_setCard",
			"setCardOpen": "OIF0DG_setCardOpen",
			"setCheck": "OIF0DG_setCheck",
			"setChevron": "OIF0DG_setChevron",
			"setChevronOpen": "OIF0DG_setChevronOpen",
			"setConfirm": "OIF0DG_setConfirm",
			"setDanger": "OIF0DG_setDanger",
			"setDesc": "OIF0DG_setDesc",
			"setHeader": "OIF0DG_setHeader",
			"setHeadText": "OIF0DG_setHeadText",
			"setHint": "OIF0DG_setHint",
			"setLabel": "OIF0DG_setLabel",
			"setLabelBox": "OIF0DG_setLabelBox",
			"setName": "OIF0DG_setName",
			"setRow": "OIF0DG_setRow",
			"setSeg": "OIF0DG_setSeg",
			"setSegBtn": "OIF0DG_setSegBtn",
			"setSegOn": "OIF0DG_setSegOn",
			"shot": "OIF0DG_shot",
			"shots": "OIF0DG_shots",
			"snapConfirmText": "OIF0DG_snapConfirmText",
			"snapList": "OIF0DG_snapList",
			"snapMeta": "OIF0DG_snapMeta",
			"snapRow": "OIF0DG_snapRow",
			"sp": "OIF0DG_sp",
			"spec": "OIF0DG_spec",
			"specTag": "OIF0DG_specTag",
			"specTagFile": "OIF0DG_specTagFile",
			"specTagGit": "OIF0DG_specTagGit",
			"spin": "OIF0DG_spin",
			"src": "OIF0DG_src",
			"staleAction": "OIF0DG_staleAction",
			"star": "OIF0DG_star",
			"stateDot": "OIF0DG_stateDot",
			"stateTag": "OIF0DG_stateTag",
			"stickyHead": "OIF0DG_stickyHead",
			"sub": "OIF0DG_sub",
			"submitLink": "OIF0DG_submitLink",
			"subTabs": "OIF0DG_subTabs",
			"swatches": "OIF0DG_swatches",
			"switch": "OIF0DG_switch",
			"switchKnob": "OIF0DG_switchKnob",
			"switchMixed": "OIF0DG_switchMixed",
			"switchOn": "OIF0DG_switchOn",
			"tab": "OIF0DG_tab",
			"tabs": "OIF0DG_tabs",
			"tabSearch": "OIF0DG_tabSearch",
			"tabSearchRow": "OIF0DG_tabSearchRow",
			"tag": "OIF0DG_tag",
			"themeActions": "OIF0DG_themeActions",
			"themeCard": "OIF0DG_themeCard",
			"themeCardBody": "OIF0DG_themeCardBody",
			"themeCardFooter": "OIF0DG_themeCardFooter",
			"themeCardHead": "OIF0DG_themeCardHead",
			"themeCover": "OIF0DG_themeCover",
			"themeCoverEmpty": "OIF0DG_themeCoverEmpty",
			"themeDescription": "OIF0DG_themeDescription",
			"themeFullscreenBtn": "OIF0DG_themeFullscreenBtn",
			"themeGallery": "OIF0DG_themeGallery",
			"themeIdentity": "OIF0DG_themeIdentity",
			"themeLifecycle": "OIF0DG_themeLifecycle",
			"themePreviewAction": "OIF0DG_themePreviewAction",
			"themePreviewCount": "OIF0DG_themePreviewCount",
			"themeResultBar": "OIF0DG_themeResultBar",
			"themeSearch": "OIF0DG_themeSearch",
			"themesGrid": "OIF0DG_themesGrid",
			"themeStatus": "OIF0DG_themeStatus",
			"themeStatusMuted": "OIF0DG_themeStatusMuted",
			"themeToolbar": "OIF0DG_themeToolbar",
			"themeToolbarActions": "OIF0DG_themeToolbarActions",
			"title": "OIF0DG_title",
			"titleRow": "OIF0DG_titleRow",
			"top": "OIF0DG_top",
			"topBtn": "OIF0DG_topBtn",
			"version": "OIF0DG_version",
			"viewBar": "OIF0DG_viewBar",
			"viewBtn": "OIF0DG_viewBtn",
			"viewOn": "OIF0DG_viewOn",
			"warnLine": "OIF0DG_warnLine"
		};
		//#endregion
