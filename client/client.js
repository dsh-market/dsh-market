window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".kWMqnG_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.kWMqnG_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.kWMqnG_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.kWMqnG_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.kWMqnG_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.kWMqnG_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.kWMqnG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.kWMqnG_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.kWMqnG_tab.kWMqnG_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.kWMqnG_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.kWMqnG_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.kWMqnG_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.kWMqnG_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.kWMqnG_body{flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.kWMqnG_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.kWMqnG_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.kWMqnG_cats{margin:0 -4px 2px;padding:12px 4px 4px}.kWMqnG_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.kWMqnG_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.kWMqnG_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.kWMqnG_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.kWMqnG_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.kWMqnG_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.kWMqnG_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.kWMqnG_catsCollapsed{max-height:62px;overflow:hidden}.kWMqnG_catsToggle.kWMqnG_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.kWMqnG_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.kWMqnG_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.kWMqnG_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.kWMqnG_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.kWMqnG_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.kWMqnG_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.kWMqnG_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.kWMqnG_lightboxClose:hover{background:#ffffff38}.kWMqnG_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.kWMqnG_lightboxNav:hover{background:#ffffff38}.kWMqnG_lightboxPrev{left:16px}.kWMqnG_lightboxNext{right:16px}.kWMqnG_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.kWMqnG_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.kWMqnG_lightboxDotOn{background:#fff}.kWMqnG_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.kWMqnG_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.kWMqnG_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.kWMqnG_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.kWMqnG_masonry{align-items:flex-start;gap:10px;display:flex}.kWMqnG_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.kWMqnG_masonry>.kWMqnG_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.kWMqnG_masonry{flex-direction:column}.kWMqnG_masonryCol{width:100%}.kWMqnG_grid{grid-template-columns:minmax(0,1fr)}}.kWMqnG_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.kWMqnG_themesGrid{margin-bottom:12px}.kWMqnG_swatches i{flex:1}.kWMqnG_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.kWMqnG_themeSearch{box-sizing:border-box;width:100%;min-width:0}.kWMqnG_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.kWMqnG_themeFullscreenBtn.kWMqnG_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.kWMqnG_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.kWMqnG_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.kWMqnG_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.kWMqnG_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.kWMqnG_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.kWMqnG_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.kWMqnG_themeCover:hover img{transform:scale(1.012)}.kWMqnG_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.kWMqnG_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.kWMqnG_themePreviewAction,.kWMqnG_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.kWMqnG_themePreviewAction{gap:4px;right:8px}.kWMqnG_themePreviewCount{left:8px}.kWMqnG_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.kWMqnG_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.kWMqnG_themeIdentity{flex:1;min-width:0}.kWMqnG_themeStatus,.kWMqnG_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.kWMqnG_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.kWMqnG_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.kWMqnG_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.kWMqnG_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.kWMqnG_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.kWMqnG_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.kWMqnG_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.kWMqnG_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.kWMqnG_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.kWMqnG_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.kWMqnG_sub>span:first-child{grid-area:1/1}.kWMqnG_sub>.kWMqnG_grow{display:none}.kWMqnG_submitLink{grid-area:2/1}.kWMqnG_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.kWMqnG_themeToolbar{grid-template-columns:minmax(0,1fr)}.kWMqnG_themeCardHead{flex-wrap:wrap}.kWMqnG_themeStatus,.kWMqnG_themeStatusMuted{order:3}}@container (width<=280px){.kWMqnG_themeCardFooter{flex-direction:column;align-items:flex-start}.kWMqnG_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.kWMqnG_themeCard,.kWMqnG_themeCover img{transition:none}.kWMqnG_themeCard:hover{transform:none}}.kWMqnG_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.kWMqnG_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.kWMqnG_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.kWMqnG_installBtn.kWMqnG_installBtn{min-width:64px}.kWMqnG_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.kWMqnG_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.kWMqnG_nmLink{color:inherit;text-decoration:none;display:block}.kWMqnG_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.kWMqnG_repoMark{color:var(--dsw-alias-label-tertiary,#8b93a1);vertical-align:-1px;flex-shrink:0;margin-left:5px}.kWMqnG_nmLink:hover .kWMqnG_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.kWMqnG_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.kWMqnG_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.kWMqnG_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.kWMqnG_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.kWMqnG_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.kWMqnG_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.kWMqnG_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.kWMqnG_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.kWMqnG_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.kWMqnG_foot .kWMqnG_metaInline,.kWMqnG_foot .kWMqnG_src{white-space:nowrap}.kWMqnG_grow{flex:1}.kWMqnG_titleRow{align-items:center;gap:10px;display:flex}.kWMqnG_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.kWMqnG_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.kWMqnG_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.kWMqnG_descTight{min-height:0}.kWMqnG_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.kWMqnG_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.kWMqnG_dot{vertical-align:2px;margin-left:5px}.kWMqnG_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.kWMqnG_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.kWMqnG_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.kWMqnG_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.kWMqnG_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.kWMqnG_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.kWMqnG_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite kWMqnG_sp;display:inline-flex}.kWMqnG_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.kWMqnG_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite kWMqnG_dshmPlug}@keyframes kWMqnG_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.kWMqnG_logoPlug,.kWMqnG_spin{animation:1.5s ease-in-out infinite kWMqnG_dshmPlugFade}}@keyframes kWMqnG_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes kWMqnG_sp{to{transform:rotate(360deg)}}.kWMqnG_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.kWMqnG_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.kWMqnG_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.kWMqnG_barWave{width:30%;animation:1.2s ease-in-out infinite kWMqnG_dshmSlide}@keyframes kWMqnG_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.kWMqnG_irow .kWMqnG_progress{margin-top:8px}.kWMqnG_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.kWMqnG_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.kWMqnG_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.kWMqnG_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.kWMqnG_conflictHead{align-items:flex-start;gap:8px;display:flex}.kWMqnG_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.kWMqnG_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.kWMqnG_conflictBody{margin:0;font-size:12px;line-height:19px}.kWMqnG_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.kWMqnG_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.kWMqnG_rosterMain{flex-direction:column;min-width:0;display:flex}.kWMqnG_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.kWMqnG_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.kWMqnG_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.kWMqnG_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.kWMqnG_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.kWMqnG_rosterRowOut .kWMqnG_rosterName{text-decoration:line-through}.kWMqnG_rosterRowOut{opacity:.62}.kWMqnG_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.kWMqnG_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.kWMqnG_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.kWMqnG_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.kWMqnG_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.kWMqnG_choices{flex-direction:column;gap:7px;display:flex}.kWMqnG_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.kWMqnG_choice:has(input:disabled){cursor:default;opacity:.6}.kWMqnG_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.kWMqnG_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.kWMqnG_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.kWMqnG_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.kWMqnG_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.kWMqnG_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.kWMqnG_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.kWMqnG_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.kWMqnG_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.kWMqnG_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.kWMqnG_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.kWMqnG_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.kWMqnG_nameLink{color:inherit;text-decoration:none}.kWMqnG_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.kWMqnG_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.kWMqnG_irowName>.kWMqnG_owner{flex:none}.kWMqnG_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.kWMqnG_opWrap{flex-shrink:0;display:inline-flex;position:relative}.kWMqnG_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.kWMqnG_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.kWMqnG_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.kWMqnG_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.kWMqnG_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.kWMqnG_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.kWMqnG_opPanelTitle{font-size:12.5px;font-weight:600}.kWMqnG_opCloseBtn.kWMqnG_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.kWMqnG_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.kWMqnG_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.kWMqnG_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.kWMqnG_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.kWMqnG_opRow:last-child{border-bottom:none}.kWMqnG_opRowAlert{background:#dc26260f}.kWMqnG_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.kWMqnG_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.kWMqnG_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.kWMqnG_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.kWMqnG_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.kWMqnG_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.kWMqnG_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.kWMqnG_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.kWMqnG_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.kWMqnG_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.kWMqnG_opDecisionFoot{align-items:center;gap:8px;display:flex}.kWMqnG_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.kWMqnG_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.kWMqnG_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.kWMqnG_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.kWMqnG_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.kWMqnG_dangerBtn.kWMqnG_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.kWMqnG_dangerBtn.kWMqnG_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.kWMqnG_dangerArmed.kWMqnG_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.kWMqnG_retryBtn{margin-top:4px}.kWMqnG_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.kWMqnG_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.kWMqnG_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.kWMqnG_irowMissing{filter:grayscale();opacity:.5}.kWMqnG_irow>.kWMqnG_src,.kWMqnG_irow>.kWMqnG_owner,.kWMqnG_irow button{white-space:nowrap;flex-shrink:0}.kWMqnG_tabSearchRow{padding:0 4px 6px;display:flex}.kWMqnG_tabSearch{width:100%}.kWMqnG_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.kWMqnG_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.kWMqnG_specTagGit{color:#0b7285;background:#12a3c41f}.kWMqnG_specTagFile{color:#b07d1b;background:#f0b42924}.kWMqnG_backupCheckList .kWMqnG_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.kWMqnG_backupCheckList .kWMqnG_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.kWMqnG_staleAction{margin-top:8px}.kWMqnG_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.kWMqnG_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.kWMqnG_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.kWMqnG_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.kWMqnG_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.kWMqnG_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.kWMqnG_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.kWMqnG_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.kWMqnG_deprecate .kWMqnG_src{margin-left:8px}.kWMqnG_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.kWMqnG_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.kWMqnG_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.kWMqnG_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.kWMqnG_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.kWMqnG_switchOn .kWMqnG_switchKnob,.kWMqnG_switchMixed .kWMqnG_switchKnob{left:18px}.kWMqnG_switch:disabled{opacity:.5;cursor:default}.kWMqnG_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.kWMqnG_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.kWMqnG_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.kWMqnG_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.kWMqnG_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.kWMqnG_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.kWMqnG_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.kWMqnG_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.kWMqnG_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.kWMqnG_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.kWMqnG_groupMember .kWMqnG_nm{flex:1;min-width:0;font-size:12px}.kWMqnG_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.kWMqnG_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.kWMqnG_inlineInput{flex:1;min-width:120px}.kWMqnG_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.kWMqnG_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.kWMqnG_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.kWMqnG_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.kWMqnG_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.kWMqnG_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.kWMqnG_backupCard h3{margin:0;font-size:14px}.kWMqnG_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.kWMqnG_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.kWMqnG_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.kWMqnG_backupInput{box-sizing:border-box;width:100%}.kWMqnG_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.kWMqnG_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.kWMqnG_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.kWMqnG_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.kWMqnG_backupCheckList .kWMqnG_backupCheck{justify-content:space-between;gap:8px}.kWMqnG_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.kWMqnG_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.kWMqnG_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.kWMqnG_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.kWMqnG_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.kWMqnG_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.kWMqnG_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.kWMqnG_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.kWMqnG_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.kWMqnG_diagBundle:first-of-type{border-top:none;padding-top:0}.kWMqnG_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.kWMqnG_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.kWMqnG_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.kWMqnG_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.kWMqnG_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.kWMqnG_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.kWMqnG_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.kWMqnG_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.kWMqnG_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.kWMqnG_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.kWMqnG_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.kWMqnG_diagList{flex-direction:column;gap:6px;display:flex}.kWMqnG_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.kWMqnG_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.kWMqnG_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.kWMqnG_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.kWMqnG_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.kWMqnG_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.kWMqnG_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.kWMqnG_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.kWMqnG_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.kWMqnG_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.kWMqnG_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.kWMqnG_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.kWMqnG_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.kWMqnG_collapseTitle{flex:1;min-width:0}.kWMqnG_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.kWMqnG_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.kWMqnG_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.kWMqnG_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.kWMqnG_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.kWMqnG_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.kWMqnG_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.kWMqnG_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.kWMqnG_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.kWMqnG_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.kWMqnG_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.kWMqnG_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.kWMqnG_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.kWMqnG_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.kWMqnG_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.kWMqnG_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.kWMqnG_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.kWMqnG_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.kWMqnG_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.kWMqnG_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.kWMqnG_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.kWMqnG_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.kWMqnG_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.kWMqnG_setChevronOpen{transform:rotate(180deg)}.kWMqnG_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.kWMqnG_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.kWMqnG_setRow+.kWMqnG_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.kWMqnG_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.kWMqnG_setLabel{font-size:13px;line-height:20px}.kWMqnG_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.kWMqnG_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.kWMqnG_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.kWMqnG_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.kWMqnG_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.kWMqnG_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.kWMqnG_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.kWMqnG_setSegBtn:disabled{cursor:default;opacity:.5}.kWMqnG_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.kWMqnG_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}";
		...
		var Market_module_css_default = {
			"act": "kWMqnG_act",
			"actBroken": "kWMqnG_actBroken",
			"actLive": "kWMqnG_actLive",
			"actWarn": "kWMqnG_actWarn",
			"actWhy": "kWMqnG_actWhy",
			"assignRow": "kWMqnG_assignRow",
			"assignSelect": "kWMqnG_assignSelect",
			"av": "kWMqnG_av",
			"backupActions": "kWMqnG_backupActions",
			"backupCard": "kWMqnG_backupCard",
			"backupCheck": "kWMqnG_backupCheck",
			"backupCheckList": "kWMqnG_backupCheckList",
			"backupGrid": "kWMqnG_backupGrid",
			"backupInput": "kWMqnG_backupInput",
			"backupMessage": "kWMqnG_backupMessage",
			"backupWarn": "kWMqnG_backupWarn",
			"banner": "kWMqnG_banner",
			"bannerHint": "kWMqnG_bannerHint",
			"bannerIcon": "kWMqnG_bannerIcon",
			"bar": "kWMqnG_bar",
			"barFill": "kWMqnG_barFill",
			"barWave": "kWMqnG_barWave",
			"body": "kWMqnG_body",
			"byline": "kWMqnG_byline",
			"card": "kWMqnG_card",
			"cardAction": "kWMqnG_cardAction",
			"cardBlocked": "kWMqnG_cardBlocked",
			"cardBlockedMark": "kWMqnG_cardBlockedMark",
			"cardShot": "kWMqnG_cardShot",
			"cardShots": "kWMqnG_cardShots",
			"cats": "kWMqnG_cats",
			"catsCollapsed": "kWMqnG_catsCollapsed",
			"catsRow": "kWMqnG_catsRow",
			"catsToggle": "kWMqnG_catsToggle",
			"catsWrap": "kWMqnG_catsWrap",
			"choice": "kWMqnG_choice",
			"choiceMain": "kWMqnG_choiceMain",
			"choiceNote": "kWMqnG_choiceNote",
			"choiceOn": "kWMqnG_choiceOn",
			"choiceRadio": "kWMqnG_choiceRadio",
			"choices": "kWMqnG_choices",
			"choiceSafe": "kWMqnG_choiceSafe",
			"choiceTitle": "kWMqnG_choiceTitle",
			"cmd": "kWMqnG_cmd",
			"collapseBody": "kWMqnG_collapseBody",
			"collapseHead": "kWMqnG_collapseHead",
			"collapseIcon": "kWMqnG_collapseIcon",
			"collapseTitle": "kWMqnG_collapseTitle",
			"confirmRow": "kWMqnG_confirmRow",
			"conflictBody": "kWMqnG_conflictBody",
			"conflictDetailsToggle": "kWMqnG_conflictDetailsToggle",
			"conflictHead": "kWMqnG_conflictHead",
			"conflictIcon": "kWMqnG_conflictIcon",
			"conflictTitle": "kWMqnG_conflictTitle",
			"conflictWhy": "kWMqnG_conflictWhy",
			"conflictWhyText": "kWMqnG_conflictWhyText",
			"dangerArmed": "kWMqnG_dangerArmed",
			"dangerBtn": "kWMqnG_dangerBtn",
			"depBadge": "kWMqnG_depBadge",
			"depLine": "kWMqnG_depLine",
			"deprecate": "kWMqnG_deprecate",
			"desc": "kWMqnG_desc",
			"descClamp": "kWMqnG_descClamp",
			"descTight": "kWMqnG_descTight",
			"descToggle": "kWMqnG_descToggle",
			"diagAlert": "kWMqnG_diagAlert",
			"diagArrow": "kWMqnG_diagArrow",
			"diagBadgeCommunity": "kWMqnG_diagBadgeCommunity",
			"diagBadgeInfo": "kWMqnG_diagBadgeInfo",
			"diagBadgeOfficial": "kWMqnG_diagBadgeOfficial",
			"diagBadgeShadow": "kWMqnG_diagBadgeShadow",
			"diagBadgeWarn": "kWMqnG_diagBadgeWarn",
			"diagBundle": "kWMqnG_diagBundle",
			"diagCount": "kWMqnG_diagCount",
			"diagEmpty": "kWMqnG_diagEmpty",
			"diagIndex": "kWMqnG_diagIndex",
			"diagKey": "kWMqnG_diagKey",
			"diagList": "kWMqnG_diagList",
			"diagMeta": "kWMqnG_diagMeta",
			"diagPage": "kWMqnG_diagPage",
			"diagRow": "kWMqnG_diagRow",
			"diagSection": "kWMqnG_diagSection",
			"diagSummary": "kWMqnG_diagSummary",
			"diagSummaryItem": "kWMqnG_diagSummaryItem",
			"diagSummaryMeta": "kWMqnG_diagSummaryMeta",
			"diagVal": "kWMqnG_diagVal",
			"dot": "kWMqnG_dot",
			"dragging": "kWMqnG_dragging",
			"dragHandle": "kWMqnG_dragHandle",
			"dragOver": "kWMqnG_dragOver",
			"dshmPlug": "kWMqnG_dshmPlug",
			"dshmPlugFade": "kWMqnG_dshmPlugFade",
			"dshmSlide": "kWMqnG_dshmSlide",
			"empty": "kWMqnG_empty",
			"err": "kWMqnG_err",
			"exportLogBtn": "kWMqnG_exportLogBtn",
			"fixFallback": "kWMqnG_fixFallback",
			"fixFallbackText": "kWMqnG_fixFallbackText",
			"foot": "kWMqnG_foot",
			"grid": "kWMqnG_grid",
			"groupActions": "kWMqnG_groupActions",
			"groupAddPanel": "kWMqnG_groupAddPanel",
			"groupCreate": "kWMqnG_groupCreate",
			"groupHead": "kWMqnG_groupHead",
			"groupHint": "kWMqnG_groupHint",
			"groupMember": "kWMqnG_groupMember",
			"groupMembers": "kWMqnG_groupMembers",
			"groupName": "kWMqnG_groupName",
			"groupRow": "kWMqnG_groupRow",
			"grow": "kWMqnG_grow",
			"head": "kWMqnG_head",
			"hiddenFile": "kWMqnG_hiddenFile",
			"inlineInput": "kWMqnG_inlineInput",
			"installBtn": "kWMqnG_installBtn",
			"irow": "kWMqnG_irow",
			"irowActions": "kWMqnG_irowActions",
			"irowMissing": "kWMqnG_irowMissing",
			"irowName": "kWMqnG_irowName",
			"irowNameText": "kWMqnG_irowNameText",
			"irowTrailing": "kWMqnG_irowTrailing",
			"lightbox": "kWMqnG_lightbox",
			"lightboxClose": "kWMqnG_lightboxClose",
			"lightboxDot": "kWMqnG_lightboxDot",
			"lightboxDotOn": "kWMqnG_lightboxDotOn",
			"lightboxDots": "kWMqnG_lightboxDots",
			"lightboxImg": "kWMqnG_lightboxImg",
			"lightboxNav": "kWMqnG_lightboxNav",
			"lightboxNext": "kWMqnG_lightboxNext",
			"lightboxPrev": "kWMqnG_lightboxPrev",
			"loading": "kWMqnG_loading",
			"logoMark": "kWMqnG_logoMark",
			"logoPlug": "kWMqnG_logoPlug",
			"masonry": "kWMqnG_masonry",
			"masonryCol": "kWMqnG_masonryCol",
			"meta": "kWMqnG_meta",
			"metaInline": "kWMqnG_metaInline",
			"metaTag": "kWMqnG_metaTag",
			"metaTagOk": "kWMqnG_metaTagOk",
			"modalNote": "kWMqnG_modalNote",
			"nameLink": "kWMqnG_nameLink",
			"nm": "kWMqnG_nm",
			"nmLink": "kWMqnG_nmLink",
			"okState": "kWMqnG_okState",
			"on": "kWMqnG_on",
			"opActions": "kWMqnG_opActions",
			"opAggregate": "kWMqnG_opAggregate",
			"opAggregateHint": "kWMqnG_opAggregateHint",
			"opAggregateTop": "kWMqnG_opAggregateTop",
			"opCloseBtn": "kWMqnG_opCloseBtn",
			"opDecision": "kWMqnG_opDecision",
			"opDecisionFoot": "kWMqnG_opDecisionFoot",
			"opDot": "kWMqnG_opDot",
			"opEmpty": "kWMqnG_opEmpty",
			"opEmptyHint": "kWMqnG_opEmptyHint",
			"opEntry": "kWMqnG_opEntry",
			"opEntryAlert": "kWMqnG_opEntryAlert",
			"opEntryQuiet": "kWMqnG_opEntryQuiet",
			"opHead": "kWMqnG_opHead",
			"opIcon": "kWMqnG_opIcon",
			"opMain": "kWMqnG_opMain",
			"opName": "kWMqnG_opName",
			"opPanel": "kWMqnG_opPanel",
			"opPanelTitle": "kWMqnG_opPanelTitle",
			"opQueuedIcon": "kWMqnG_opQueuedIcon",
			"opRow": "kWMqnG_opRow",
			"opRowAlert": "kWMqnG_opRowAlert",
			"opStatus": "kWMqnG_opStatus",
			"opStatusBad": "kWMqnG_opStatusBad",
			"opTop": "kWMqnG_opTop",
			"opVerb": "kWMqnG_opVerb",
			"opWrap": "kWMqnG_opWrap",
			"orderPanel": "kWMqnG_orderPanel",
			"orphBadge": "kWMqnG_orphBadge",
			"orphRow": "kWMqnG_orphRow",
			"ovArrow": "kWMqnG_ovArrow",
			"ovByTag": "kWMqnG_ovByTag",
			"ovFrom": "kWMqnG_ovFrom",
			"ovRow": "kWMqnG_ovRow",
			"owner": "kWMqnG_owner",
			"pageEllipsis": "kWMqnG_pageEllipsis",
			"pageInfo": "kWMqnG_pageInfo",
			"pager": "kWMqnG_pager",
			"pagerPages": "kWMqnG_pagerPages",
			"panelActions": "kWMqnG_panelActions",
			"panelNote": "kWMqnG_panelNote",
			"pct": "kWMqnG_pct",
			"presetList": "kWMqnG_presetList",
			"presetName": "kWMqnG_presetName",
			"presetRow": "kWMqnG_presetRow",
			"progress": "kWMqnG_progress",
			"reassure": "kWMqnG_reassure",
			"reassureOk": "kWMqnG_reassureOk",
			"repoLink": "kWMqnG_repoLink",
			"repoMark": "kWMqnG_repoMark",
			"retryBtn": "kWMqnG_retryBtn",
			"root": "kWMqnG_root",
			"roster": "kWMqnG_roster",
			"rosterAuthor": "kWMqnG_rosterAuthor",
			"rosterMain": "kWMqnG_rosterMain",
			"rosterName": "kWMqnG_rosterName",
			"rosterRow": "kWMqnG_rosterRow",
			"rosterRowOut": "kWMqnG_rosterRowOut",
			"rosterSplit": "kWMqnG_rosterSplit",
			"rosterTag": "kWMqnG_rosterTag",
			"rosterTagDrop": "kWMqnG_rosterTagDrop",
			"rosterTagKeep": "kWMqnG_rosterTagKeep",
			"row1": "kWMqnG_row1",
			"sectAction": "kWMqnG_sectAction",
			"sectionOverview": "kWMqnG_sectionOverview",
			"setActions": "kWMqnG_setActions",
			"setBetaTag": "kWMqnG_setBetaTag",
			"setBody": "kWMqnG_setBody",
			"setCard": "kWMqnG_setCard",
			"setCardOpen": "kWMqnG_setCardOpen",
			"setCheck": "kWMqnG_setCheck",
			"setChevron": "kWMqnG_setChevron",
			"setChevronOpen": "kWMqnG_setChevronOpen",
			"setConfirm": "kWMqnG_setConfirm",
			"setDanger": "kWMqnG_setDanger",
			"setDesc": "kWMqnG_setDesc",
			"setHeader": "kWMqnG_setHeader",
			"setHeadText": "kWMqnG_setHeadText",
			"setHint": "kWMqnG_setHint",
			"setLabel": "kWMqnG_setLabel",
			"setLabelBox": "kWMqnG_setLabelBox",
			"setName": "kWMqnG_setName",
			"setRow": "kWMqnG_setRow",
			"setSeg": "kWMqnG_setSeg",
			"setSegBtn": "kWMqnG_setSegBtn",
			"setSegOn": "kWMqnG_setSegOn",
			"shot": "kWMqnG_shot",
			"shots": "kWMqnG_shots",
			"snapConfirmText": "kWMqnG_snapConfirmText",
			"snapList": "kWMqnG_snapList",
			"snapMeta": "kWMqnG_snapMeta",
			"snapRow": "kWMqnG_snapRow",
			"sp": "kWMqnG_sp",
			"spec": "kWMqnG_spec",
			"specTag": "kWMqnG_specTag",
			"specTagFile": "kWMqnG_specTagFile",
			"specTagGit": "kWMqnG_specTagGit",
			"spin": "kWMqnG_spin",
			"src": "kWMqnG_src",
			"staleAction": "kWMqnG_staleAction",
			"star": "kWMqnG_star",
			"stateDot": "kWMqnG_stateDot",
			"stateTag": "kWMqnG_stateTag",
			"stickyHead": "kWMqnG_stickyHead",
			"sub": "kWMqnG_sub",
			"submitLink": "kWMqnG_submitLink",
			"subTabs": "kWMqnG_subTabs",
			"swatches": "kWMqnG_swatches",
			"switch": "kWMqnG_switch",
			"switchKnob": "kWMqnG_switchKnob",
			"switchMixed": "kWMqnG_switchMixed",
			"switchOn": "kWMqnG_switchOn",
			"tab": "kWMqnG_tab",
			"tabs": "kWMqnG_tabs",
			"tabSearch": "kWMqnG_tabSearch",
			"tabSearchRow": "kWMqnG_tabSearchRow",
			"tag": "kWMqnG_tag",
			"themeActions": "kWMqnG_themeActions",
			"themeCard": "kWMqnG_themeCard",
			"themeCardBody": "kWMqnG_themeCardBody",
			"themeCardFooter": "kWMqnG_themeCardFooter",
			"themeCardHead": "kWMqnG_themeCardHead",
			"themeCover": "kWMqnG_themeCover",
			"themeCoverEmpty": "kWMqnG_themeCoverEmpty",
			"themeDescription": "kWMqnG_themeDescription",
			"themeFullscreenBtn": "kWMqnG_themeFullscreenBtn",
			"themeGallery": "kWMqnG_themeGallery",
			"themeIdentity": "kWMqnG_themeIdentity",
			"themeLifecycle": "kWMqnG_themeLifecycle",
			"themePreviewAction": "kWMqnG_themePreviewAction",
			"themePreviewCount": "kWMqnG_themePreviewCount",
			"themeResultBar": "kWMqnG_themeResultBar",
			"themeSearch": "kWMqnG_themeSearch",
			"themesGrid": "kWMqnG_themesGrid",
			"themeStatus": "kWMqnG_themeStatus",
			"themeStatusMuted": "kWMqnG_themeStatusMuted",
			"themeToolbar": "kWMqnG_themeToolbar",
			"themeToolbarActions": "kWMqnG_themeToolbarActions",
			"title": "kWMqnG_title",
			"titleRow": "kWMqnG_titleRow",
			"top": "kWMqnG_top",
			"topBtn": "kWMqnG_topBtn",
			"version": "kWMqnG_version",
			"viewBar": "kWMqnG_viewBar",
			"viewBtn": "kWMqnG_viewBtn",
			"viewOn": "kWMqnG_viewOn",
			"warnLine": "kWMqnG_warnLine"
		};
		//#endregion
