window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const MCP_CONNECTOR_INTERNAL_DESCRIPTION = {
		...
		*/
		function pluginForInternalMarket(plugin) {
			if (plugin.name !== "dsh-mcp-connector" || plugin.owner !== "duhu2000" || plugin.npm !== "dsh-mcp-connector" || plugin.url !== "https://github.com/duhu2000/dsh-mcp-connector") return plugin;
			return {
				...plugin,
				description: {
					...plugin.description,
		...
		function registryForInternalMarket(registry) {
			return {
				...registry,
