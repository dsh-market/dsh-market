window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".H6IP1q_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.H6IP1q_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.H6IP1q_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.H6IP1q_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.H6IP1q_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.H6IP1q_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.H6IP1q_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.H6IP1q_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.H6IP1q_tab.H6IP1q_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.H6IP1q_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.H6IP1q_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.H6IP1q_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.H6IP1q_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.H6IP1q_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.H6IP1q_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.H6IP1q_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.H6IP1q_cats{margin:0 -4px 2px;padding:12px 4px 4px}.H6IP1q_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.H6IP1q_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.H6IP1q_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.H6IP1q_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.H6IP1q_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.H6IP1q_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.H6IP1q_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.H6IP1q_catsCollapsed{max-height:62px;overflow:hidden}.H6IP1q_catsToggle.H6IP1q_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.H6IP1q_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.H6IP1q_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.H6IP1q_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.H6IP1q_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.H6IP1q_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.H6IP1q_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.H6IP1q_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.H6IP1q_lightboxClose:hover{background:#ffffff38}.H6IP1q_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.H6IP1q_lightboxNav:hover{background:#ffffff38}.H6IP1q_lightboxPrev{left:16px}.H6IP1q_lightboxNext{right:16px}.H6IP1q_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.H6IP1q_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.H6IP1q_lightboxDotOn{background:#fff}.H6IP1q_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.H6IP1q_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.H6IP1q_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.H6IP1q_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.H6IP1q_masonry{align-items:flex-start;gap:10px;display:flex}.H6IP1q_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.H6IP1q_masonry>.H6IP1q_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.H6IP1q_masonry{flex-direction:column}.H6IP1q_masonryCol{width:100%}.H6IP1q_grid{grid-template-columns:minmax(0,1fr)}}.H6IP1q_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.H6IP1q_themesGrid{margin-bottom:12px}.H6IP1q_swatches i{flex:1}.H6IP1q_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.H6IP1q_themeSearch{box-sizing:border-box;width:100%;min-width:0}.H6IP1q_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.H6IP1q_themeFullscreenBtn.H6IP1q_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.H6IP1q_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.H6IP1q_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.H6IP1q_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.H6IP1q_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.H6IP1q_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.H6IP1q_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.H6IP1q_themeCover:hover img{transform:scale(1.012)}.H6IP1q_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.H6IP1q_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.H6IP1q_themePreviewAction,.H6IP1q_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.H6IP1q_themePreviewAction{gap:4px;right:8px}.H6IP1q_themePreviewCount{left:8px}.H6IP1q_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.H6IP1q_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.H6IP1q_themeIdentity{flex:1;min-width:0}.H6IP1q_themeStatus,.H6IP1q_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.H6IP1q_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.H6IP1q_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.H6IP1q_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.H6IP1q_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.H6IP1q_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.H6IP1q_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.H6IP1q_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.H6IP1q_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.H6IP1q_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.H6IP1q_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.H6IP1q_sub>span:first-child{grid-area:1/1}.H6IP1q_sub>.H6IP1q_grow{display:none}.H6IP1q_submitLink{grid-area:2/1}.H6IP1q_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.H6IP1q_themeToolbar{grid-template-columns:minmax(0,1fr)}.H6IP1q_themeCardHead{flex-wrap:wrap}.H6IP1q_themeStatus,.H6IP1q_themeStatusMuted{order:3}}@container (width<=280px){.H6IP1q_themeCardFooter{flex-direction:column;align-items:flex-start}.H6IP1q_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.H6IP1q_themeCard,.H6IP1q_themeCover img{transition:none}.H6IP1q_themeCard:hover{transform:none}}.H6IP1q_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.H6IP1q_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.H6IP1q_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.H6IP1q_installBtn.H6IP1q_installBtn{min-width:64px}.H6IP1q_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.H6IP1q_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.H6IP1q_nmLink{color:inherit;text-decoration:none;display:block}.H6IP1q_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.H6IP1q_repoMark{color:var(--dsw-alias-label-tertiary,#8b93a1);vertical-align:-1px;flex-shrink:0;margin-left:5px}.H6IP1q_nmLink:hover .H6IP1q_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.H6IP1q_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.H6IP1q_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.H6IP1q_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.H6IP1q_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.H6IP1q_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.H6IP1q_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.H6IP1q_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.H6IP1q_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.H6IP1q_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.H6IP1q_foot .H6IP1q_metaInline,.H6IP1q_foot .H6IP1q_src{white-space:nowrap}.H6IP1q_grow{flex:1}.H6IP1q_titleRow{align-items:center;gap:10px;display:flex}.H6IP1q_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.H6IP1q_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.H6IP1q_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.H6IP1q_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.H6IP1q_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.H6IP1q_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.H6IP1q_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.H6IP1q_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.H6IP1q_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.H6IP1q_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.H6IP1q_noteInput{flex:1;min-width:160px}.H6IP1q_descTight{min-height:0}.H6IP1q_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.H6IP1q_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.H6IP1q_dot{vertical-align:2px;margin-left:5px}.H6IP1q_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.H6IP1q_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.H6IP1q_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.H6IP1q_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.H6IP1q_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.H6IP1q_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.H6IP1q_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite H6IP1q_sp;display:inline-flex}.H6IP1q_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.H6IP1q_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite H6IP1q_dshmPlug}@keyframes H6IP1q_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.H6IP1q_logoPlug,.H6IP1q_spin{animation:1.5s ease-in-out infinite H6IP1q_dshmPlugFade}}@keyframes H6IP1q_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes H6IP1q_sp{to{transform:rotate(360deg)}}.H6IP1q_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.H6IP1q_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.H6IP1q_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.H6IP1q_barWave{width:30%;animation:1.2s ease-in-out infinite H6IP1q_dshmSlide}@keyframes H6IP1q_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.H6IP1q_irow .H6IP1q_progress{margin-top:8px}.H6IP1q_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.H6IP1q_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.H6IP1q_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.H6IP1q_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.H6IP1q_conflictHead{align-items:flex-start;gap:8px;display:flex}.H6IP1q_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.H6IP1q_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.H6IP1q_conflictBody{margin:0;font-size:12px;line-height:19px}.H6IP1q_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.H6IP1q_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.H6IP1q_rosterMain{flex-direction:column;min-width:0;display:flex}.H6IP1q_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.H6IP1q_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.H6IP1q_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.H6IP1q_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.H6IP1q_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.H6IP1q_rosterRowOut .H6IP1q_rosterName{text-decoration:line-through}.H6IP1q_rosterRowOut{opacity:.62}.H6IP1q_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.H6IP1q_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.H6IP1q_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.H6IP1q_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.H6IP1q_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.H6IP1q_choices{flex-direction:column;gap:7px;display:flex}.H6IP1q_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.H6IP1q_choice:has(input:disabled){cursor:default;opacity:.6}.H6IP1q_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.H6IP1q_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.H6IP1q_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.H6IP1q_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.H6IP1q_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.H6IP1q_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.H6IP1q_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.H6IP1q_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.H6IP1q_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.H6IP1q_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.H6IP1q_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.H6IP1q_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.H6IP1q_nameLink{color:inherit;text-decoration:none}.H6IP1q_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.H6IP1q_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.H6IP1q_irowName>.H6IP1q_owner{flex:none}.H6IP1q_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.H6IP1q_opWrap{flex-shrink:0;display:inline-flex;position:relative}.H6IP1q_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.H6IP1q_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.H6IP1q_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.H6IP1q_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.H6IP1q_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.H6IP1q_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.H6IP1q_opPanelTitle{font-size:12.5px;font-weight:600}.H6IP1q_opCloseBtn.H6IP1q_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.H6IP1q_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.H6IP1q_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.H6IP1q_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.H6IP1q_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.H6IP1q_opRow:last-child{border-bottom:none}.H6IP1q_opRowAlert{background:#dc26260f}.H6IP1q_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.H6IP1q_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.H6IP1q_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.H6IP1q_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.H6IP1q_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.H6IP1q_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.H6IP1q_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.H6IP1q_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.H6IP1q_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.H6IP1q_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.H6IP1q_opDecisionFoot{align-items:center;gap:8px;display:flex}.H6IP1q_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.H6IP1q_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.H6IP1q_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.H6IP1q_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.H6IP1q_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.H6IP1q_dangerBtn.H6IP1q_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.H6IP1q_dangerBtn.H6IP1q_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.H6IP1q_dangerArmed.H6IP1q_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.H6IP1q_retryBtn{margin-top:4px}.H6IP1q_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.H6IP1q_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.H6IP1q_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.H6IP1q_irowMissing{filter:grayscale();opacity:.5}.H6IP1q_irow>.H6IP1q_src,.H6IP1q_irow>.H6IP1q_owner,.H6IP1q_irow button{white-space:nowrap;flex-shrink:0}.H6IP1q_tabSearchRow{padding:0 4px 6px;display:flex}.H6IP1q_tabSearch{width:100%}.H6IP1q_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.H6IP1q_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.H6IP1q_specTagGit{color:#0b7285;background:#12a3c41f}.H6IP1q_specTagFile{color:#b07d1b;background:#f0b42924}.H6IP1q_backupCheckList .H6IP1q_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.H6IP1q_backupCheckList .H6IP1q_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.H6IP1q_staleAction{margin-top:8px}.H6IP1q_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.H6IP1q_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.H6IP1q_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.H6IP1q_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.H6IP1q_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.H6IP1q_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.H6IP1q_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.H6IP1q_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.H6IP1q_deprecate .H6IP1q_src{margin-left:8px}.H6IP1q_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.H6IP1q_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.H6IP1q_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.H6IP1q_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.H6IP1q_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.H6IP1q_switchOn .H6IP1q_switchKnob,.H6IP1q_switchMixed .H6IP1q_switchKnob{left:18px}.H6IP1q_switch:disabled{opacity:.5;cursor:default}.H6IP1q_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.H6IP1q_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.H6IP1q_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.H6IP1q_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.H6IP1q_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.H6IP1q_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.H6IP1q_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.H6IP1q_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.H6IP1q_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.H6IP1q_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.H6IP1q_groupMember .H6IP1q_nm{flex:1;min-width:0;font-size:12px}.H6IP1q_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.H6IP1q_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.H6IP1q_inlineInput{flex:1;min-width:120px}.H6IP1q_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.H6IP1q_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.H6IP1q_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.H6IP1q_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.H6IP1q_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.H6IP1q_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.H6IP1q_backupCard h3{margin:0;font-size:14px}.H6IP1q_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.H6IP1q_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.H6IP1q_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.H6IP1q_backupInput{box-sizing:border-box;width:100%}.H6IP1q_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.H6IP1q_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.H6IP1q_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.H6IP1q_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.H6IP1q_backupCheckList .H6IP1q_backupCheck{justify-content:space-between;gap:8px}.H6IP1q_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.H6IP1q_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.H6IP1q_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.H6IP1q_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.H6IP1q_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.H6IP1q_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.H6IP1q_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.H6IP1q_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.H6IP1q_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.H6IP1q_diagBundle:first-of-type{border-top:none;padding-top:0}.H6IP1q_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.H6IP1q_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.H6IP1q_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.H6IP1q_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.H6IP1q_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.H6IP1q_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.H6IP1q_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.H6IP1q_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.H6IP1q_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.H6IP1q_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.H6IP1q_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.H6IP1q_diagList{flex-direction:column;gap:6px;display:flex}.H6IP1q_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.H6IP1q_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.H6IP1q_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.H6IP1q_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.H6IP1q_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.H6IP1q_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.H6IP1q_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.H6IP1q_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.H6IP1q_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.H6IP1q_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.H6IP1q_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.H6IP1q_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.H6IP1q_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.H6IP1q_collapseTitle{flex:1;min-width:0}.H6IP1q_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.H6IP1q_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.H6IP1q_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.H6IP1q_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.H6IP1q_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.H6IP1q_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.H6IP1q_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.H6IP1q_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.H6IP1q_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.H6IP1q_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.H6IP1q_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.H6IP1q_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.H6IP1q_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.H6IP1q_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.H6IP1q_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.H6IP1q_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.H6IP1q_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.H6IP1q_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.H6IP1q_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.H6IP1q_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.H6IP1q_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.H6IP1q_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.H6IP1q_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.H6IP1q_setChevronOpen{transform:rotate(180deg)}.H6IP1q_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.H6IP1q_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.H6IP1q_setRow+.H6IP1q_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.H6IP1q_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.H6IP1q_setLabel{font-size:13px;line-height:20px}.H6IP1q_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.H6IP1q_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.H6IP1q_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.H6IP1q_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.H6IP1q_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.H6IP1q_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.H6IP1q_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.H6IP1q_setSegBtn:disabled{cursor:default;opacity:.5}.H6IP1q_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.H6IP1q_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.H6IP1q_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}.H6IP1q_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.H6IP1q_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}.H6IP1q_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}.H6IP1q_commentsStatus:empty{display:none}.H6IP1q_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}.H6IP1q_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}.H6IP1q_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}.H6IP1q_commentsMount iframe{width:100%}.H6IP1q_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}.H6IP1q_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}.H6IP1q_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}.H6IP1q_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}.H6IP1q_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}.H6IP1q_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}.H6IP1q_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.H6IP1q_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}.H6IP1q_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}.H6IP1q_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}.H6IP1q_notesP{font-size:13px;line-height:20px}.H6IP1q_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}.H6IP1q_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}.H6IP1q_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}.H6IP1q_notesRow:last-child{border-bottom:none}.H6IP1q_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}.H6IP1q_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}.H6IP1q_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}.H6IP1q_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}.H6IP1q_notesVer{color:inherit;font-weight:600;text-decoration:none}.H6IP1q_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "H6IP1q_act",
			"actBroken": "H6IP1q_actBroken",
			"actLive": "H6IP1q_actLive",
			"actWarn": "H6IP1q_actWarn",
			"actWhy": "H6IP1q_actWhy",
			"assignRow": "H6IP1q_assignRow",
			"assignSelect": "H6IP1q_assignSelect",
			"av": "H6IP1q_av",
			"backupActions": "H6IP1q_backupActions",
			"backupCard": "H6IP1q_backupCard",
			"backupCheck": "H6IP1q_backupCheck",
			"backupCheckList": "H6IP1q_backupCheckList",
			"backupGrid": "H6IP1q_backupGrid",
			"backupInput": "H6IP1q_backupInput",
			"backupMessage": "H6IP1q_backupMessage",
			"backupWarn": "H6IP1q_backupWarn",
			"banner": "H6IP1q_banner",
			"bannerHint": "H6IP1q_bannerHint",
			"bannerIcon": "H6IP1q_bannerIcon",
			"bar": "H6IP1q_bar",
			"barFill": "H6IP1q_barFill",
			"barWave": "H6IP1q_barWave",
			"body": "H6IP1q_body",
			"byline": "H6IP1q_byline",
			"card": "H6IP1q_card",
			"cardAction": "H6IP1q_cardAction",
			"cardBlocked": "H6IP1q_cardBlocked",
			"cardBlockedMark": "H6IP1q_cardBlockedMark",
			"cardShot": "H6IP1q_cardShot",
			"cardShots": "H6IP1q_cardShots",
			"cats": "H6IP1q_cats",
			"catsCollapsed": "H6IP1q_catsCollapsed",
			"catsRow": "H6IP1q_catsRow",
			"catsToggle": "H6IP1q_catsToggle",
			"catsWrap": "H6IP1q_catsWrap",
			"choice": "H6IP1q_choice",
			"choiceMain": "H6IP1q_choiceMain",
			"choiceNote": "H6IP1q_choiceNote",
			"choiceOn": "H6IP1q_choiceOn",
			"choiceRadio": "H6IP1q_choiceRadio",
			"choices": "H6IP1q_choices",
			"choiceSafe": "H6IP1q_choiceSafe",
			"choiceTitle": "H6IP1q_choiceTitle",
			"cmd": "H6IP1q_cmd",
			"collapseBody": "H6IP1q_collapseBody",
			"collapseHead": "H6IP1q_collapseHead",
			"collapseIcon": "H6IP1q_collapseIcon",
			"collapseTitle": "H6IP1q_collapseTitle",
			"commentsError": "H6IP1q_commentsError",
			"commentsFail": "H6IP1q_commentsFail",
			"commentsLink": "H6IP1q_commentsLink",
			"commentsMount": "H6IP1q_commentsMount",
			"commentsNote": "H6IP1q_commentsNote",
			"commentsStatus": "H6IP1q_commentsStatus",
			"confirmRow": "H6IP1q_confirmRow",
			"conflictBody": "H6IP1q_conflictBody",
			"conflictDetailsToggle": "H6IP1q_conflictDetailsToggle",
			"conflictHead": "H6IP1q_conflictHead",
			"conflictIcon": "H6IP1q_conflictIcon",
			"conflictTitle": "H6IP1q_conflictTitle",
			"conflictWhy": "H6IP1q_conflictWhy",
			"conflictWhyText": "H6IP1q_conflictWhyText",
			"dangerArmed": "H6IP1q_dangerArmed",
			"dangerBtn": "H6IP1q_dangerBtn",
			"depBadge": "H6IP1q_depBadge",
			"depLine": "H6IP1q_depLine",
			"deprecate": "H6IP1q_deprecate",
			"desc": "H6IP1q_desc",
			"descClamp": "H6IP1q_descClamp",
			"descTight": "H6IP1q_descTight",
			"descToggle": "H6IP1q_descToggle",
			"diagAlert": "H6IP1q_diagAlert",
			"diagArrow": "H6IP1q_diagArrow",
			"diagBadgeCommunity": "H6IP1q_diagBadgeCommunity",
			"diagBadgeInfo": "H6IP1q_diagBadgeInfo",
			"diagBadgeOfficial": "H6IP1q_diagBadgeOfficial",
			"diagBadgeShadow": "H6IP1q_diagBadgeShadow",
			"diagBadgeWarn": "H6IP1q_diagBadgeWarn",
			"diagBundle": "H6IP1q_diagBundle",
			"diagCount": "H6IP1q_diagCount",
			"diagEmpty": "H6IP1q_diagEmpty",
			"diagIndex": "H6IP1q_diagIndex",
			"diagKey": "H6IP1q_diagKey",
			"diagList": "H6IP1q_diagList",
			"diagMeta": "H6IP1q_diagMeta",
			"diagPage": "H6IP1q_diagPage",
			"diagRow": "H6IP1q_diagRow",
			"diagSection": "H6IP1q_diagSection",
			"diagSummary": "H6IP1q_diagSummary",
			"diagSummaryItem": "H6IP1q_diagSummaryItem",
			"diagSummaryMeta": "H6IP1q_diagSummaryMeta",
			"diagVal": "H6IP1q_diagVal",
			"dot": "H6IP1q_dot",
			"dragging": "H6IP1q_dragging",
			"dragHandle": "H6IP1q_dragHandle",
			"dragOver": "H6IP1q_dragOver",
			"dshmPlug": "H6IP1q_dshmPlug",
			"dshmPlugFade": "H6IP1q_dshmPlugFade",
			"dshmSlide": "H6IP1q_dshmSlide",
			"empty": "H6IP1q_empty",
			"err": "H6IP1q_err",
			"exportLogBtn": "H6IP1q_exportLogBtn",
			"fixFallback": "H6IP1q_fixFallback",
			"fixFallbackText": "H6IP1q_fixFallbackText",
			"foot": "H6IP1q_foot",
			"grid": "H6IP1q_grid",
			"groupActions": "H6IP1q_groupActions",
			"groupAddPanel": "H6IP1q_groupAddPanel",
			"groupCreate": "H6IP1q_groupCreate",
			"groupHead": "H6IP1q_groupHead",
			"groupHint": "H6IP1q_groupHint",
			"groupMember": "H6IP1q_groupMember",
			"groupMembers": "H6IP1q_groupMembers",
			"groupName": "H6IP1q_groupName",
			"groupRow": "H6IP1q_groupRow",
			"grow": "H6IP1q_grow",
			"head": "H6IP1q_head",
			"hiddenFile": "H6IP1q_hiddenFile",
			"inlineInput": "H6IP1q_inlineInput",
			"installBtn": "H6IP1q_installBtn",
			"irow": "H6IP1q_irow",
			"irowActions": "H6IP1q_irowActions",
			"irowMissing": "H6IP1q_irowMissing",
			"irowName": "H6IP1q_irowName",
			"irowNameText": "H6IP1q_irowNameText",
			"irowTrailing": "H6IP1q_irowTrailing",
			"lightbox": "H6IP1q_lightbox",
			"lightboxClose": "H6IP1q_lightboxClose",
			"lightboxDot": "H6IP1q_lightboxDot",
			"lightboxDotOn": "H6IP1q_lightboxDotOn",
			"lightboxDots": "H6IP1q_lightboxDots",
			"lightboxImg": "H6IP1q_lightboxImg",
			"lightboxNav": "H6IP1q_lightboxNav",
			"lightboxNext": "H6IP1q_lightboxNext",
			"lightboxPrev": "H6IP1q_lightboxPrev",
			"loading": "H6IP1q_loading",
			"logoMark": "H6IP1q_logoMark",
			"logoPlug": "H6IP1q_logoPlug",
			"masonry": "H6IP1q_masonry",
			"masonryCol": "H6IP1q_masonryCol",
			"meta": "H6IP1q_meta",
			"metaInline": "H6IP1q_metaInline",
			"metaTag": "H6IP1q_metaTag",
			"metaTagOk": "H6IP1q_metaTagOk",
			"modalNote": "H6IP1q_modalNote",
			"nameLink": "H6IP1q_nameLink",
			"nm": "H6IP1q_nm",
			"nmLink": "H6IP1q_nmLink",
			"noteAction": "H6IP1q_noteAction",
			"noteEdit": "H6IP1q_noteEdit",
			"noteInput": "H6IP1q_noteInput",
			"noteMine": "H6IP1q_noteMine",
			"noteRow": "H6IP1q_noteRow",
			"notesArrow": "H6IP1q_notesArrow",
			"notesBody": "H6IP1q_notesBody",
			"notesCode": "H6IP1q_notesCode",
			"notesDate": "H6IP1q_notesDate",
			"notesH": "H6IP1q_notesH",
			"notesLink": "H6IP1q_notesLink",
			"notesList": "H6IP1q_notesList",
			"notesMeta": "H6IP1q_notesMeta",
			"notesMsg": "H6IP1q_notesMsg",
			"notesP": "H6IP1q_notesP",
			"notesPre": "H6IP1q_notesPre",
			"notesRange": "H6IP1q_notesRange",
			"notesRendered": "H6IP1q_notesRendered",
			"notesRow": "H6IP1q_notesRow",
			"notesSha": "H6IP1q_notesSha",
			"notesVer": "H6IP1q_notesVer",
			"noteToggle": "H6IP1q_noteToggle",
			"okState": "H6IP1q_okState",
			"on": "H6IP1q_on",
			"opActions": "H6IP1q_opActions",
			"opAggregate": "H6IP1q_opAggregate",
			"opAggregateHint": "H6IP1q_opAggregateHint",
			"opAggregateTop": "H6IP1q_opAggregateTop",
			"opCloseBtn": "H6IP1q_opCloseBtn",
			"opDecision": "H6IP1q_opDecision",
			"opDecisionFoot": "H6IP1q_opDecisionFoot",
			"opDot": "H6IP1q_opDot",
			"opEmpty": "H6IP1q_opEmpty",
			"opEmptyHint": "H6IP1q_opEmptyHint",
			"opEntry": "H6IP1q_opEntry",
			"opEntryAlert": "H6IP1q_opEntryAlert",
			"opEntryQuiet": "H6IP1q_opEntryQuiet",
			"opHead": "H6IP1q_opHead",
			"opIcon": "H6IP1q_opIcon",
			"opMain": "H6IP1q_opMain",
			"opName": "H6IP1q_opName",
			"opPanel": "H6IP1q_opPanel",
			"opPanelTitle": "H6IP1q_opPanelTitle",
			"opQueuedIcon": "H6IP1q_opQueuedIcon",
			"opRow": "H6IP1q_opRow",
			"opRowAlert": "H6IP1q_opRowAlert",
			"opStatus": "H6IP1q_opStatus",
			"opStatusBad": "H6IP1q_opStatusBad",
			"opTop": "H6IP1q_opTop",
			"opVerb": "H6IP1q_opVerb",
			"opWrap": "H6IP1q_opWrap",
			"orderPanel": "H6IP1q_orderPanel",
			"orphBadge": "H6IP1q_orphBadge",
			"orphRow": "H6IP1q_orphRow",
			"ovArrow": "H6IP1q_ovArrow",
			"ovByTag": "H6IP1q_ovByTag",
			"ovFrom": "H6IP1q_ovFrom",
			"ovRow": "H6IP1q_ovRow",
			"owner": "H6IP1q_owner",
			"pageEllipsis": "H6IP1q_pageEllipsis",
			"pageInfo": "H6IP1q_pageInfo",
			"pager": "H6IP1q_pager",
			"pagerPages": "H6IP1q_pagerPages",
			"panelActions": "H6IP1q_panelActions",
			"panelNote": "H6IP1q_panelNote",
			"pct": "H6IP1q_pct",
			"presetList": "H6IP1q_presetList",
			"presetName": "H6IP1q_presetName",
			"presetRow": "H6IP1q_presetRow",
			"progress": "H6IP1q_progress",
			"reassure": "H6IP1q_reassure",
			"reassureOk": "H6IP1q_reassureOk",
			"repoLink": "H6IP1q_repoLink",
			"repoMark": "H6IP1q_repoMark",
			"retryBtn": "H6IP1q_retryBtn",
			"root": "H6IP1q_root",
			"roster": "H6IP1q_roster",
			"rosterAuthor": "H6IP1q_rosterAuthor",
			"rosterMain": "H6IP1q_rosterMain",
			"rosterName": "H6IP1q_rosterName",
			"rosterRow": "H6IP1q_rosterRow",
			"rosterRowOut": "H6IP1q_rosterRowOut",
			"rosterSplit": "H6IP1q_rosterSplit",
			"rosterTag": "H6IP1q_rosterTag",
			"rosterTagDrop": "H6IP1q_rosterTagDrop",
			"rosterTagKeep": "H6IP1q_rosterTagKeep",
			"row1": "H6IP1q_row1",
			"sectAction": "H6IP1q_sectAction",
			"sectionOverview": "H6IP1q_sectionOverview",
			"setActions": "H6IP1q_setActions",
			"setBetaTag": "H6IP1q_setBetaTag",
			"setBody": "H6IP1q_setBody",
			"setCard": "H6IP1q_setCard",
			"setCardOpen": "H6IP1q_setCardOpen",
			"setCheck": "H6IP1q_setCheck",
			"setChevron": "H6IP1q_setChevron",
			"setChevronOpen": "H6IP1q_setChevronOpen",
			"setConfirm": "H6IP1q_setConfirm",
			"setDanger": "H6IP1q_setDanger",
			"setDesc": "H6IP1q_setDesc",
			"setHeader": "H6IP1q_setHeader",
			"setHeadText": "H6IP1q_setHeadText",
			"setHint": "H6IP1q_setHint",
			"setLabel": "H6IP1q_setLabel",
			"setLabelBox": "H6IP1q_setLabelBox",
			"setName": "H6IP1q_setName",
			"setRow": "H6IP1q_setRow",
			"setSeg": "H6IP1q_setSeg",
			"setSegBtn": "H6IP1q_setSegBtn",
			"setSegOn": "H6IP1q_setSegOn",
			"shot": "H6IP1q_shot",
			"shots": "H6IP1q_shots",
			"snapConfirmText": "H6IP1q_snapConfirmText",
			"snapList": "H6IP1q_snapList",
			"snapMeta": "H6IP1q_snapMeta",
			"snapRow": "H6IP1q_snapRow",
			"sp": "H6IP1q_sp",
			"spec": "H6IP1q_spec",
			"specTag": "H6IP1q_specTag",
			"specTagFile": "H6IP1q_specTagFile",
			"specTagGit": "H6IP1q_specTagGit",
			"spin": "H6IP1q_spin",
			"src": "H6IP1q_src",
			"staleAction": "H6IP1q_staleAction",
			"star": "H6IP1q_star",
			"stateDot": "H6IP1q_stateDot",
			"stateTag": "H6IP1q_stateTag",
			"stickyHead": "H6IP1q_stickyHead",
			"sub": "H6IP1q_sub",
			"submitLink": "H6IP1q_submitLink",
			"subTabs": "H6IP1q_subTabs",
			"swatches": "H6IP1q_swatches",
			"switch": "H6IP1q_switch",
			"switchKnob": "H6IP1q_switchKnob",
			"switchMixed": "H6IP1q_switchMixed",
			"switchOn": "H6IP1q_switchOn",
			"tab": "H6IP1q_tab",
			"tabs": "H6IP1q_tabs",
			"tabSearch": "H6IP1q_tabSearch",
			"tabSearchRow": "H6IP1q_tabSearchRow",
			"tag": "H6IP1q_tag",
			"themeActions": "H6IP1q_themeActions",
			"themeCard": "H6IP1q_themeCard",
			"themeCardBody": "H6IP1q_themeCardBody",
			"themeCardFooter": "H6IP1q_themeCardFooter",
			"themeCardHead": "H6IP1q_themeCardHead",
			"themeCover": "H6IP1q_themeCover",
			"themeCoverEmpty": "H6IP1q_themeCoverEmpty",
			"themeDescription": "H6IP1q_themeDescription",
			"themeFullscreenBtn": "H6IP1q_themeFullscreenBtn",
			"themeGallery": "H6IP1q_themeGallery",
			"themeIdentity": "H6IP1q_themeIdentity",
			"themeLifecycle": "H6IP1q_themeLifecycle",
			"themePreviewAction": "H6IP1q_themePreviewAction",
			"themePreviewCount": "H6IP1q_themePreviewCount",
			"themeResultBar": "H6IP1q_themeResultBar",
			"themeSearch": "H6IP1q_themeSearch",
			"themesGrid": "H6IP1q_themesGrid",
			"themeStatus": "H6IP1q_themeStatus",
			"themeStatusMuted": "H6IP1q_themeStatusMuted",
			"themeToolbar": "H6IP1q_themeToolbar",
			"themeToolbarActions": "H6IP1q_themeToolbarActions",
			"title": "H6IP1q_title",
			"titleRow": "H6IP1q_titleRow",
			"top": "H6IP1q_top",
			"topBtn": "H6IP1q_topBtn",
			"version": "H6IP1q_version",
			"viewBar": "H6IP1q_viewBar",
			"viewBtn": "H6IP1q_viewBtn",
			"viewOn": "H6IP1q_viewOn",
			"warnLine": "H6IP1q_warnLine"
		};
		//#endregion
