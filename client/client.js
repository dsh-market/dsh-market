window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		const zh = {
			...
			favoriteAdd: "加入收藏",
			favoriteRemove: "取消收藏",
			favoritesEmpty: "还没有收藏的插件。在「发现」里点书签图标即可加入。",
			...
			favoriteUnavailable: "收藏接口不可用。请在本目录执行 pnpm run build 后重启 dsh web。",
		...
		const en = {
			...
			favoritesEmpty: "No favorites yet. Bookmark plugins in Discover to save them here.",
			...
			favoriteUnavailable: "Favorites API is unavailable. Run pnpm run build in the market repo, then restart dsh web.",
		...
		*/
		...
		const css = ".rYj1mq_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.rYj1mq_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.rYj1mq_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.rYj1mq_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.rYj1mq_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.rYj1mq_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.rYj1mq_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.rYj1mq_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.rYj1mq_tab.rYj1mq_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.rYj1mq_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.rYj1mq_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.rYj1mq_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.rYj1mq_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.rYj1mq_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.rYj1mq_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.rYj1mq_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.rYj1mq_cats{margin:0 -4px 2px;padding:12px 4px 4px}.rYj1mq_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.rYj1mq_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.rYj1mq_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.rYj1mq_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.rYj1mq_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.rYj1mq_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.rYj1mq_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.rYj1mq_catsCollapsed{max-height:62px;overflow:hidden}.rYj1mq_catsToggle.rYj1mq_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.rYj1mq_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.rYj1mq_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.rYj1mq_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.rYj1mq_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.rYj1mq_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.rYj1mq_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.rYj1mq_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.rYj1mq_lightboxClose:hover{background:#ffffff38}.rYj1mq_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.rYj1mq_lightboxNav:hover{background:#ffffff38}.rYj1mq_lightboxPrev{left:16px}.rYj1mq_lightboxNext{right:16px}.rYj1mq_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.rYj1mq_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.rYj1mq_lightboxDotOn{background:#fff}.rYj1mq_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.rYj1mq_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.rYj1mq_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.rYj1mq_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.rYj1mq_masonry{align-items:flex-start;gap:10px;display:flex}.rYj1mq_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.rYj1mq_masonry>.rYj1mq_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.rYj1mq_masonry{flex-direction:column}.rYj1mq_masonryCol{width:100%}.rYj1mq_grid{grid-template-columns:minmax(0,1fr)}}.rYj1mq_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.rYj1mq_themesGrid{margin-bottom:12px}.rYj1mq_swatches i{flex:1}.rYj1mq_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.rYj1mq_themeSearch{box-sizing:border-box;width:100%;min-width:0}.rYj1mq_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.rYj1mq_themeFullscreenBtn.rYj1mq_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.rYj1mq_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.rYj1mq_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.rYj1mq_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.rYj1mq_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.rYj1mq_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.rYj1mq_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.rYj1mq_themeCover:hover img{transform:scale(1.012)}.rYj1mq_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.rYj1mq_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.rYj1mq_themePreviewAction,.rYj1mq_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.rYj1mq_themePreviewAction{gap:4px;right:8px}.rYj1mq_themePreviewCount{left:8px}.rYj1mq_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.rYj1mq_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.rYj1mq_themeIdentity{flex:1;min-width:0}.rYj1mq_themeStatus,.rYj1mq_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.rYj1mq_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.rYj1mq_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.rYj1mq_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.rYj1mq_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.rYj1mq_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.rYj1mq_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.rYj1mq_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.rYj1mq_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.rYj1mq_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.rYj1mq_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.rYj1mq_sub>span:first-child{grid-area:1/1}.rYj1mq_sub>.rYj1mq_grow{display:none}.rYj1mq_submitLink{grid-area:2/1}.rYj1mq_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.rYj1mq_themeToolbar{grid-template-columns:minmax(0,1fr)}.rYj1mq_themeCardHead{flex-wrap:wrap}.rYj1mq_themeStatus,.rYj1mq_themeStatusMuted{order:3}}@container (width<=280px){.rYj1mq_themeCardFooter{flex-direction:column;align-items:flex-start}.rYj1mq_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.rYj1mq_themeCard,.rYj1mq_themeCover img{transition:none}.rYj1mq_themeCard:hover{transform:none}}.rYj1mq_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.rYj1mq_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.rYj1mq_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.rYj1mq_installBtn.rYj1mq_installBtn{min-width:64px}.rYj1mq_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.rYj1mq_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.rYj1mq_nmLink{color:inherit;text-decoration:none;display:block}.rYj1mq_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.rYj1mq_repoMark{color:var(--dsw-alias-label-secondary,#6b7280);vertical-align:-1px;flex-shrink:0;margin-left:5px;display:inline-block}.rYj1mq_nmLink:hover .rYj1mq_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.rYj1mq_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.rYj1mq_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.rYj1mq_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.rYj1mq_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.rYj1mq_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.rYj1mq_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.rYj1mq_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.rYj1mq_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.rYj1mq_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.rYj1mq_foot .rYj1mq_metaInline,.rYj1mq_foot .rYj1mq_src{white-space:nowrap}.rYj1mq_grow{flex:1}.rYj1mq_titleRow{align-items:center;gap:10px;display:flex}.rYj1mq_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.rYj1mq_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.rYj1mq_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.rYj1mq_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.rYj1mq_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.rYj1mq_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.rYj1mq_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.rYj1mq_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.rYj1mq_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.rYj1mq_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.rYj1mq_noteInput{flex:1;min-width:160px}.rYj1mq_descTight{min-height:0}.rYj1mq_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.rYj1mq_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.rYj1mq_dot{vertical-align:2px;margin-left:5px}.rYj1mq_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.rYj1mq_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.rYj1mq_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.rYj1mq_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.rYj1mq_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.rYj1mq_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.rYj1mq_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite rYj1mq_sp;display:inline-flex}.rYj1mq_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.rYj1mq_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite rYj1mq_dshmPlug}@keyframes rYj1mq_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.rYj1mq_logoPlug,.rYj1mq_spin{animation:1.5s ease-in-out infinite rYj1mq_dshmPlugFade}}@keyframes rYj1mq_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes rYj1mq_sp{to{transform:rotate(360deg)}}.rYj1mq_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.rYj1mq_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.rYj1mq_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.rYj1mq_barWave{width:30%;animation:1.2s ease-in-out infinite rYj1mq_dshmSlide}@keyframes rYj1mq_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.rYj1mq_irow .rYj1mq_progress{margin-top:8px}.rYj1mq_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.rYj1mq_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.rYj1mq_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.rYj1mq_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.rYj1mq_conflictHead{align-items:flex-start;gap:8px;display:flex}.rYj1mq_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.rYj1mq_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.rYj1mq_conflictBody{margin:0;font-size:12px;line-height:19px}.rYj1mq_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.rYj1mq_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.rYj1mq_rosterMain{flex-direction:column;min-width:0;display:flex}.rYj1mq_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.rYj1mq_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.rYj1mq_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.rYj1mq_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.rYj1mq_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.rYj1mq_rosterRowOut .rYj1mq_rosterName{text-decoration:line-through}.rYj1mq_rosterRowOut{opacity:.62}.rYj1mq_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.rYj1mq_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.rYj1mq_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.rYj1mq_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.rYj1mq_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.rYj1mq_choices{flex-direction:column;gap:7px;display:flex}.rYj1mq_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.rYj1mq_choice:has(input:disabled){cursor:default;opacity:.6}.rYj1mq_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}
notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "rYj1mq_act",
			"actBroken": "rYj1mq_actBroken",
			"actLive": "rYj1mq_actLive",
			"actWarn": "rYj1mq_actWarn",
			"actWhy": "rYj1mq_actWhy",
			"assignRow": "rYj1mq_assignRow",
			"assignSelect": "rYj1mq_assignSelect",
			"av": "rYj1mq_av",
			"backupActions": "rYj1mq_backupActions",
			"backupCard": "rYj1mq_backupCard",
			"backupCheck": "rYj1mq_backupCheck",
			"backupCheckList": "rYj1mq_backupCheckList",
			"backupGrid": "rYj1mq_backupGrid",
			"backupInput": "rYj1mq_backupInput",
			"backupMessage": "rYj1mq_backupMessage",
			"backupWarn": "rYj1mq_backupWarn",
			"banner": "rYj1mq_banner",
			"bannerHint": "rYj1mq_bannerHint",
			"bannerIcon": "rYj1mq_bannerIcon",
			"bar": "rYj1mq_bar",
			"barFill": "rYj1mq_barFill",
			"barWave": "rYj1mq_barWave",
			"body": "rYj1mq_body",
			"byline": "rYj1mq_byline",
			"card": "rYj1mq_card",
			"cardAction": "rYj1mq_cardAction",
			"cardBlocked": "rYj1mq_cardBlocked",
			"cardBlockedMark": "rYj1mq_cardBlockedMark",
			"cardShot": "rYj1mq_cardShot",
			"cardShots": "rYj1mq_cardShots",
			"cats": "rYj1mq_cats",
			"catsCollapsed": "rYj1mq_catsCollapsed",
			"catsRow": "rYj1mq_catsRow",
			"catsToggle": "rYj1mq_catsToggle",
			"catsWrap": "rYj1mq_catsWrap",
			"choice": "rYj1mq_choice",
			"choiceMain": "rYj1mq_choiceMain",
			"choiceNote": "rYj1mq_choiceNote",
			"choiceOn": "rYj1mq_choiceOn",
			"choiceRadio": "rYj1mq_choiceRadio",
			"choices": "rYj1mq_choices",
			"choiceSafe": "rYj1mq_choiceSafe",
			"choiceTitle": "rYj1mq_choiceTitle",
			"cmd": "rYj1mq_cmd",
			"collapseBody": "rYj1mq_collapseBody",
			"collapseHead": "rYj1mq_collapseHead",
			"collapseIcon": "rYj1mq_collapseIcon",
			"collapseTitle": "rYj1mq_collapseTitle",
			"commentsError": "rYj1mq_commentsError",
			"commentsFail": "rYj1mq_commentsFail",
			"commentsLink": "rYj1mq_commentsLink",
			"commentsMount": "rYj1mq_commentsMount",
			"commentsNote": "rYj1mq_commentsNote",
			"commentsStatus": "rYj1mq_commentsStatus",
			"confirmRow": "rYj1mq_confirmRow",
			"conflictBody": "rYj1mq_conflictBody",
			"conflictDetailsToggle": "rYj1mq_conflictDetailsToggle",
			"conflictHead": "rYj1mq_conflictHead",
			"conflictIcon": "rYj1mq_conflictIcon",
			"conflictTitle": "rYj1mq_conflictTitle",
			"conflictWhy": "rYj1mq_conflictWhy",
			"conflictWhyText": "rYj1mq_conflictWhyText",
			"dangerArmed": "rYj1mq_dangerArmed",
			"dangerBtn": "rYj1mq_dangerBtn",
			"depBadge": "rYj1mq_depBadge",
			"depLine": "rYj1mq_depLine",
			"deprecate": "rYj1mq_deprecate",
			"desc": "rYj1mq_desc",
			"descClamp": "rYj1mq_descClamp",
			"descTight": "rYj1mq_descTight",
			"descToggle": "rYj1mq_descToggle",
			"diagAlert": "rYj1mq_diagAlert",
			"diagArrow": "rYj1mq_diagArrow",
			"diagBadgeCommunity": "rYj1mq_diagBadgeCommunity",
			"diagBadgeInfo": "rYj1mq_diagBadgeInfo",
			"diagBadgeOfficial": "rYj1mq_diagBadgeOfficial",
			"diagBadgeShadow": "rYj1mq_diagBadgeShadow",
			"diagBadgeWarn": "rYj1mq_diagBadgeWarn",
			"diagBundle": "rYj1mq_diagBundle",
			"diagCount": "rYj1mq_diagCount",
			"diagEmpty": "rYj1mq_diagEmpty",
			"diagIndex": "rYj1mq_diagIndex",
			"diagKey": "rYj1mq_diagKey",
			"diagList": "rYj1mq_diagList",
			"diagMeta": "rYj1mq_diagMeta",
			"diagPage": "rYj1mq_diagPage",
			"diagRow": "rYj1mq_diagRow",
			"diagSection": "rYj1mq_diagSection",
			"diagSummary": "rYj1mq_diagSummary",
			"diagSummaryItem": "rYj1mq_diagSummaryItem",
			"diagSummaryMeta": "rYj1mq_diagSummaryMeta",
			"diagVal": "rYj1mq_diagVal",
			"dot": "rYj1mq_dot",
			"dragging": "rYj1mq_dragging",
			"dragHandle": "rYj1mq_dragHandle",
			"dragOver": "rYj1mq_dragOver",
			"dshmPlug": "rYj1mq_dshmPlug",
			"dshmPlugFade": "rYj1mq_dshmPlugFade",
			"dshmSlide": "rYj1mq_dshmSlide",
			"empty": "rYj1mq_empty",
			"err": "rYj1mq_err",
			"exportLogBtn": "rYj1mq_exportLogBtn",
			"favoriteBtn": "rYj1mq_favoriteBtn",
			"favoriteOn": "rYj1mq_favoriteOn",
			"fixFallback": "rYj1mq_fixFallback",
			"fixFallbackText": "rYj1mq_fixFallbackText",
			"foot": "rYj1mq_foot",
			"footActions": "rYj1mq_footActions",
			"grid": "rYj1mq_grid",
			"groupActions": "rYj1mq_groupActions",
			"groupAddPanel": "rYj1mq_groupAddPanel",
			"groupCreate": "rYj1mq_groupCreate",
			"groupHead": "rYj1mq_groupHead",
			"groupHint": "rYj1mq_groupHint",
			"groupMember": "rYj1mq_groupMember",
			"groupMembers": "rYj1mq_groupMembers",
			"groupName": "rYj1mq_groupName",
			"groupRow": "rYj1mq_groupRow",
			"grow": "rYj1mq_grow",
			"head": "rYj1mq_head",
			"hiddenFile": "rYj1mq_hiddenFile",
			"inlineInput": "rYj1mq_inlineInput",
			"installBtn": "rYj1mq_installBtn",
			"irow": "rYj1mq_irow",
			"irowActions": "rYj1mq_irowActions",
			"irowMissing": "rYj1mq_irowMissing",
			"irowName": "rYj1mq_irowName",
			"irowNameText": "rYj1mq_irowNameText",
			"irowTrailing": "rYj1mq_irowTrailing",
			"lightbox": "rYj1mq_lightbox",
			"lightboxClose": "rYj1mq_lightboxClose",
			"lightboxDot": "rYj1mq_lightboxDot",
			"lightboxDotOn": "rYj1mq_lightboxDotOn",
			"lightboxDots": "rYj1mq_lightboxDots",
			"lightboxImg": "rYj1mq_lightboxImg",
			"lightboxNav": "rYj1mq_lightboxNav",
			"lightboxNext": "rYj1mq_lightboxNext",
			"lightboxPrev": "rYj1mq_lightboxPrev",
			"loading": "rYj1mq_loading",
			"logoMark": "rYj1mq_logoMark",
			"logoPlug": "rYj1mq_logoPlug",
			"masonry": "rYj1mq_masonry",
			"masonryCol": "rYj1mq_masonryCol",
			"meta": "rYj1mq_meta",
			"metaInline": "rYj1mq_metaInline",
			"metaTag": "rYj1mq_metaTag",
			"metaTagOk": "rYj1mq_metaTagOk",
			"modalNote": "rYj1mq_modalNote",
			"nameLink": "rYj1mq_nameLink",
			"nm": "rYj1mq_nm",
			"nmLink": "rYj1mq_nmLink",
			"noteAction": "rYj1mq_noteAction",
			"noteEdit": "rYj1mq_noteEdit",
			"noteInput": "rYj1mq_noteInput",
			"noteMine": "rYj1mq_noteMine",
			"noteRow": "rYj1mq_noteRow",
			"notesArrow": "rYj1mq_notesArrow",
			"notesBody": "rYj1mq_notesBody",
			"notesCode": "rYj1mq_notesCode",
			"notesDate": "rYj1mq_notesDate",
			"notesH": "rYj1mq_notesH",
			"notesLink": "rYj1mq_notesLink",
			"notesList": "rYj1mq_notesList",
			"notesMeta": "rYj1mq_notesMeta",
			"notesMsg": "rYj1mq_notesMsg",
			"notesP": "rYj1mq_notesP",
			"notesPre": "rYj1mq_notesPre",
			"notesRange": "rYj1mq_notesRange",
			"notesRendered": "rYj1mq_notesRendered",
			"notesRow": "rYj1mq_notesRow",
			"notesSha": "rYj1mq_notesSha",
			"notesVer": "rYj1mq_notesVer",
			"noteToggle": "rYj1mq_noteToggle",
			"okState": "rYj1mq_okState",
			"on": "rYj1mq_on",
			"opActions": "rYj1mq_opActions",
			"opAggregate": "rYj1mq_opAggregate",
			"opAggregateHint": "rYj1mq_opAggregateHint",
			"opAggregateTop": "rYj1mq_opAggregateTop",
			"opCloseBtn": "rYj1mq_opCloseBtn",
			"opDecision": "rYj1mq_opDecision",
			"opDecisionFoot": "rYj1mq_opDecisionFoot",
			"opDot": "rYj1mq_opDot",
			"opEmpty": "rYj1mq_opEmpty",
			"opEmptyHint": "rYj1mq_opEmptyHint",
			"opEntry": "rYj1mq_opEntry",
			"opEntryAlert": "rYj1mq_opEntryAlert",
			"opEntryQuiet": "rYj1mq_opEntryQuiet",
			"opHead": "rYj1mq_opHead",
			"opIcon": "rYj1mq_opIcon",
			"opMain": "rYj1mq_opMain",
			"opName": "rYj1mq_opName",
			"opPanel": "rYj1mq_opPanel",
			"opPanelTitle": "rYj1mq_opPanelTitle",
			"opQueuedIcon": "rYj1mq_opQueuedIcon",
			"opRow": "rYj1mq_opRow",
			"opRowAlert": "rYj1mq_opRowAlert",
			"opStatus": "rYj1mq_opStatus",
			"opStatusBad": "rYj1mq_opStatusBad",
			"opTop": "rYj1mq_opTop",
			"opVerb": "rYj1mq_opVerb",
			"opWrap": "rYj1mq_opWrap",
			"orderPanel": "rYj1mq_orderPanel",
			"orphBadge": "rYj1mq_orphBadge",
			"orphRow": "rYj1mq_orphRow",
			"ovArrow": "rYj1mq_ovArrow",
			"ovByTag": "rYj1mq_ovByTag",
			"ovFrom": "rYj1mq_ovFrom",
			"ovRow": "rYj1mq_ovRow",
			"owner": "rYj1mq_owner",
			"pageEllipsis": "rYj1mq_pageEllipsis",
			"pageInfo": "rYj1mq_pageInfo",
			"pager": "rYj1mq_pager",
			"pagerPages": "rYj1mq_pagerPages",
			"panelActions": "rYj1mq_panelActions",
			"panelNote": "rYj1mq_panelNote",
			"pct": "rYj1mq_pct",
			"presetList": "rYj1mq_presetList",
			"presetName": "rYj1mq_presetName",
			"presetRow": "rYj1mq_presetRow",
			"progress": "rYj1mq_progress",
			"reassure": "rYj1mq_reassure",
			"reassureOk": "rYj1mq_reassureOk",
			"repoLink": "rYj1mq_repoLink",
			"repoMark": "rYj1mq_repoMark",
			"retryBtn": "rYj1mq_retryBtn",
			"root": "rYj1mq_root",
			"roster": "rYj1mq_roster",
			"rosterAuthor": "rYj1mq_rosterAuthor",
			"rosterMain": "rYj1mq_rosterMain",
			"rosterName": "rYj1mq_rosterName",
			"rosterRow": "rYj1mq_rosterRow",
			"rosterRowOut": "rYj1mq_rosterRowOut",
			"rosterSplit": "rYj1mq_rosterSplit",
			"rosterTag": "rYj1mq_rosterTag",
			"rosterTagDrop": "rYj1mq_rosterTagDrop",
			"rosterTagKeep": "rYj1mq_rosterTagKeep",
			"row1": "rYj1mq_row1",
			"sectAction": "rYj1mq_sectAction",
			"sectionOverview": "rYj1mq_sectionOverview",
			"setActions": "rYj1mq_setActions",
			"setBetaTag": "rYj1mq_setBetaTag",
			"setBody": "rYj1mq_setBody",
			"setCard": "rYj1mq_setCard",
			"setCardOpen": "rYj1mq_setCardOpen",
			"setCheck": "rYj1mq_setCheck",
			"setChevron": "rYj1mq_setChevron",
			"setChevronOpen": "rYj1mq_setChevronOpen",
			"setConfirm": "rYj1mq_setConfirm",
			"setDanger": "rYj1mq_setDanger",
			"setDesc": "rYj1mq_setDesc",
			"setHeader": "rYj1mq_setHeader",
			"setHeadText": "rYj1mq_setHeadText",
			"setHint": "rYj1mq_setHint",
			"setLabel": "rYj1mq_setLabel",
			"setLabelBox": "rYj1mq_setLabelBox",
			"setName": "rYj1mq_setName",
			"setRow": "rYj1mq_setRow",
			"setSeg": "rYj1mq_setSeg",
			"setSegBtn": "rYj1mq_setSegBtn",
			"setSegOn": "rYj1mq_setSegOn",
			"shot": "rYj1mq_shot",
			"shots": "rYj1mq_shots",
			"snapConfirmText": "rYj1mq_snapConfirmText",
			"snapList": "rYj1mq_snapList",
			"snapMeta": "rYj1mq_snapMeta",
			"snapRow": "rYj1mq_snapRow",
			"sp": "rYj1mq_sp",
			"spec": "rYj1mq_spec",
			"specTag": "rYj1mq_specTag",
			"specTagFile": "rYj1mq_specTagFile",
			"specTagGit": "rYj1mq_specTagGit",
			"spin": "rYj1mq_spin",
			"src": "rYj1mq_src",
			"staleAction": "rYj1mq_staleAction",
			"star": "rYj1mq_star",
			"stateDot": "rYj1mq_stateDot",
			"stateTag": "rYj1mq_stateTag",
			"stickyHead": "rYj1mq_stickyHead",
			"sub": "rYj1mq_sub",
			"submitLink": "rYj1mq_submitLink",
			"subTabs": "rYj1mq_subTabs",
			"swatches": "rYj1mq_swatches",
			"switch": "rYj1mq_switch",
			"switchKnob": "rYj1mq_switchKnob",
			"switchMixed": "rYj1mq_switchMixed",
			"switchOn": "rYj1mq_switchOn",
			"tab": "rYj1mq_tab",
			"tabs": "rYj1mq_tabs",
			"tabSearch": "rYj1mq_tabSearch",
			"tabSearchRow": "rYj1mq_tabSearchRow",
			"tag": "rYj1mq_tag",
			"themeActions": "rYj1mq_themeActions",
			"themeCard": "rYj1mq_themeCard",
			"themeCardBody": "rYj1mq_themeCardBody",
			"themeCardFooter": "rYj1mq_themeCardFooter",
			"themeCardHead": "rYj1mq_themeCardHead",
			"themeCover": "rYj1mq_themeCover",
			"themeCoverEmpty": "rYj1mq_themeCoverEmpty",
			"themeDescription": "rYj1mq_themeDescription",
			"themeFullscreenBtn": "rYj1mq_themeFullscreenBtn",
			"themeGallery": "rYj1mq_themeGallery",
			"themeIdentity": "rYj1mq_themeIdentity",
			"themeLifecycle": "rYj1mq_themeLifecycle",
			"themePreviewAction": "rYj1mq_themePreviewAction",
			"themePreviewCount": "rYj1mq_themePreviewCount",
			"themeResultBar": "rYj1mq_themeResultBar",
			"themeSearch": "rYj1mq_themeSearch",
			"themesGrid": "rYj1mq_themesGrid",
			"themeStatus": "rYj1mq_themeStatus",
			"themeStatusMuted": "rYj1mq_themeStatusMuted",
			"themeToolbar": "rYj1mq_themeToolbar",
			"themeToolbarActions": "rYj1mq_themeToolbarActions",
			"title": "rYj1mq_title",
			"titleRow": "rYj1mq_titleRow",
			"top": "rYj1mq_top",
			"topBtn": "rYj1mq_topBtn",
			"version": "rYj1mq_version",
			"viewBar": "rYj1mq_viewBar",
			"viewBtn": "rYj1mq_viewBtn",
			"viewOn": "rYj1mq_viewOn",
			"warnLine": "rYj1mq_warnLine"
		};
		//#endregion
		...
		*/
		...
		function MarketSection(props) {
			...
			*  pinned during scroll, distinct from the two-row collapsed default. */
			...
			const favoritePagination = usePagination(favoriteListed.length, [
				qFavorites,
				favSortField,
				favSortDir,
				favTimeRange
			], scrollToTop);
			const favoritePagePlugins = favoriteListed.slice((favoritePagination.currentPage - 1) * favoritePagination.pageSize, favoritePagination.currentPage * favoritePagination.pageSize);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										children: t("tabFavorites") + (favoriteUrls.length > 0 ? " (" + favoriteUrls.length + ")" : "")
									}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: tab === "backup" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), favoriteListed.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.empty,
							children: t("empty")
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: favoritePagePlugins.map((p) => pluginCategories(p).includes("theme") ? themePluginCard(p) : pluginCard(p))
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Pager, {
