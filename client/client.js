setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}";
		...
		var Market_module_css_default = {
			"act": "BBY0qq_act",
			"actBroken": "BBY0qq_actBroken",
			"actLive": "BBY0qq_actLive",
			"actWarn": "BBY0qq_actWarn",
			"actWhy": "BBY0qq_actWhy",
			"assignRow": "BBY0qq_assignRow",
			"assignSelect": "BBY0qq_assignSelect",
			"av": "BBY0qq_av",
			"backupActions": "BBY0qq_backupActions",
			"backupCard": "BBY0qq_backupCard",
			"backupCheck": "BBY0qq_backupCheck",
			"backupCheckList": "BBY0qq_backupCheckList",
			"backupGrid": "BBY0qq_backupGrid",
			"backupInput": "BBY0qq_backupInput",
			"backupMessage": "BBY0qq_backupMessage",
			"backupWarn": "BBY0qq_backupWarn",
			"banner": "BBY0qq_banner",
			"bannerHint": "BBY0qq_bannerHint",
			"bannerIcon": "BBY0qq_bannerIcon",
			"bar": "BBY0qq_bar",
			"barFill": "BBY0qq_barFill",
			"barWave": "BBY0qq_barWave",
			"body": "BBY0qq_body",
			"byline": "BBY0qq_byline",
			"card": "BBY0qq_card",
			"cardAction": "BBY0qq_cardAction",
			"cardBlocked": "BBY0qq_cardBlocked",
			"cardBlockedMark": "BBY0qq_cardBlockedMark",
			"cardHeadRight": "BBY0qq_cardHeadRight",
			"cardRepoLink": "BBY0qq_cardRepoLink",
			"cardShot": "BBY0qq_cardShot",
			"cardShots": "BBY0qq_cardShots",
			"cats": "BBY0qq_cats",
			"catsCollapsed": "BBY0qq_catsCollapsed",
			"catsRow": "BBY0qq_catsRow",
			"catsToggle": "BBY0qq_catsToggle",
			"catsWrap": "BBY0qq_catsWrap",
			"choice": "BBY0qq_choice",
			"choiceMain": "BBY0qq_choiceMain",
			"choiceNote": "BBY0qq_choiceNote",
			"choiceOn": "BBY0qq_choiceOn",
			"choiceRadio": "BBY0qq_choiceRadio",
			"choices": "BBY0qq_choices",
			"choiceSafe": "BBY0qq_choiceSafe",
			"choiceTitle": "BBY0qq_choiceTitle",
			"cmd": "BBY0qq_cmd",
			"collapseBody": "BBY0qq_collapseBody",
			"collapseHead": "BBY0qq_collapseHead",
			"collapseIcon": "BBY0qq_collapseIcon",
			"collapseTitle": "BBY0qq_collapseTitle",
			"conflictBody": "BBY0qq_conflictBody",
			"conflictDetailsToggle": "BBY0qq_conflictDetailsToggle",
			"conflictHead": "BBY0qq_conflictHead",
			"conflictIcon": "BBY0qq_conflictIcon",
			"conflictTitle": "BBY0qq_conflictTitle",
			"conflictWhy": "BBY0qq_conflictWhy",
			"conflictWhyText": "BBY0qq_conflictWhyText",
			"dangerArmed": "BBY0qq_dangerArmed",
			"dangerBtn": "BBY0qq_dangerBtn",
			"depBadge": "BBY0qq_depBadge",
			"depLine": "BBY0qq_depLine",
			"deprecate": "BBY0qq_deprecate",
			"desc": "BBY0qq_desc",
			"descClamp": "BBY0qq_descClamp",
			"descTight": "BBY0qq_descTight",
			"descToggle": "BBY0qq_descToggle",
			"diagAlert": "BBY0qq_diagAlert",
			"diagArrow": "BBY0qq_diagArrow",
			"diagBadgeCommunity": "BBY0qq_diagBadgeCommunity",
			"diagBadgeOfficial": "BBY0qq_diagBadgeOfficial",
			"diagBadgeShadow": "BBY0qq_diagBadgeShadow",
			"diagBundle": "BBY0qq_diagBundle",
			"diagCount": "BBY0qq_diagCount",
			"diagEmpty": "BBY0qq_diagEmpty",
			"diagIndex": "BBY0qq_diagIndex",
			"diagKey": "BBY0qq_diagKey",
			"diagList": "BBY0qq_diagList",
			"diagMeta": "BBY0qq_diagMeta",
			"diagPage": "BBY0qq_diagPage",
			"diagRow": "BBY0qq_diagRow",
			"diagSection": "BBY0qq_diagSection",
			"diagSummary": "BBY0qq_diagSummary",
			"diagSummaryItem": "BBY0qq_diagSummaryItem",
			"diagSummaryMeta": "BBY0qq_diagSummaryMeta",
			"diagVal": "BBY0qq_diagVal",
			"dot": "BBY0qq_dot",
			"dragging": "BBY0qq_dragging",
			"dragHandle": "BBY0qq_dragHandle",
			"dragOver": "BBY0qq_dragOver",
			"dshmPlug": "BBY0qq_dshmPlug",
			"dshmPlugFade": "BBY0qq_dshmPlugFade",
			"dshmSlide": "BBY0qq_dshmSlide",
			"empty": "BBY0qq_empty",
			"err": "BBY0qq_err",
			"fixFallback": "BBY0qq_fixFallback",
			"fixFallbackText": "BBY0qq_fixFallbackText",
			"foot": "BBY0qq_foot",
			"grid": "BBY0qq_grid",
			"groupActions": "BBY0qq_groupActions",
			"groupAddPanel": "BBY0qq_groupAddPanel",
			"groupCreate": "BBY0qq_groupCreate",
			"groupHead": "BBY0qq_groupHead",
			"groupHint": "BBY0qq_groupHint",
			"groupMember": "BBY0qq_groupMember",
			"groupMembers": "BBY0qq_groupMembers",
			"groupName": "BBY0qq_groupName",
			"groupRow": "BBY0qq_groupRow",
			"grow": "BBY0qq_grow",
			"head": "BBY0qq_head",
			"hiddenFile": "BBY0qq_hiddenFile",
			"inlineInput": "BBY0qq_inlineInput",
			"installBtn": "BBY0qq_installBtn",
			"irow": "BBY0qq_irow",
			"irowActions": "BBY0qq_irowActions",
			"irowMissing": "BBY0qq_irowMissing",
			"irowTrailing": "BBY0qq_irowTrailing",
			"lightbox": "BBY0qq_lightbox",
			"lightboxClose": "BBY0qq_lightboxClose",
			"lightboxDot": "BBY0qq_lightboxDot",
			"lightboxDotOn": "BBY0qq_lightboxDotOn",
			"lightboxDots": "BBY0qq_lightboxDots",
			"lightboxImg": "BBY0qq_lightboxImg",
			"lightboxNav": "BBY0qq_lightboxNav",
			"lightboxNext": "BBY0qq_lightboxNext",
			"lightboxPrev": "BBY0qq_lightboxPrev",
			"loading": "BBY0qq_loading",
			"logoMark": "BBY0qq_logoMark",
			"logoPlug": "BBY0qq_logoPlug",
			"masonry": "BBY0qq_masonry",
			"masonryCol": "BBY0qq_masonryCol",
			"meta": "BBY0qq_meta",
			"metaInline": "BBY0qq_metaInline",
			"metaTag": "BBY0qq_metaTag",
			"metaTagOk": "BBY0qq_metaTagOk",
			"modalNote": "BBY0qq_modalNote",
			"nameLink": "BBY0qq_nameLink",
			"nm": "BBY0qq_nm",
			"nmLink": "BBY0qq_nmLink",
			"okState": "BBY0qq_okState",
			"on": "BBY0qq_on",
			"opActions": "BBY0qq_opActions",
			"opAggregate": "BBY0qq_opAggregate",
			"opAggregateHint": "BBY0qq_opAggregateHint",
			"opAggregateTop": "BBY0qq_opAggregateTop",
			"opCloseBtn": "BBY0qq_opCloseBtn",
			"opDecision": "BBY0qq_opDecision",
			"opDecisionFoot": "BBY0qq_opDecisionFoot",
			"opDot": "BBY0qq_opDot",
			"opEmpty": "BBY0qq_opEmpty",
			"opEmptyHint": "BBY0qq_opEmptyHint",
			"opEntry": "BBY0qq_opEntry",
			"opEntryAlert": "BBY0qq_opEntryAlert",
			"opEntryQuiet": "BBY0qq_opEntryQuiet",
			"opHead": "BBY0qq_opHead",
			"opIcon": "BBY0qq_opIcon",
			"opMain": "BBY0qq_opMain",
			"opName": "BBY0qq_opName",
			"opPanel": "BBY0qq_opPanel",
			"opPanelTitle": "BBY0qq_opPanelTitle",
			"opQueuedIcon": "BBY0qq_opQueuedIcon",
			"opRow": "BBY0qq_opRow",
			"opRowAlert": "BBY0qq_opRowAlert",
			"opStatus": "BBY0qq_opStatus",
			"opStatusBad": "BBY0qq_opStatusBad",
			"opTop": "BBY0qq_opTop",
			"opVerb": "BBY0qq_opVerb",
			"opWrap": "BBY0qq_opWrap",
			"orphBadge": "BBY0qq_orphBadge",
			"orphRow": "BBY0qq_orphRow",
			"ovArrow": "BBY0qq_ovArrow",
			"ovByTag": "BBY0qq_ovByTag",
			"ovFrom": "BBY0qq_ovFrom",
			"ovRow": "BBY0qq_ovRow",
			"owner": "BBY0qq_owner",
			"pageEllipsis": "BBY0qq_pageEllipsis",
			"pageInfo": "BBY0qq_pageInfo",
			"pager": "BBY0qq_pager",
			"pagerPages": "BBY0qq_pagerPages",
			"pairGrid": "BBY0qq_pairGrid",
			"panelNote": "BBY0qq_panelNote",
			"pct": "BBY0qq_pct",
			"progress": "BBY0qq_progress",
			"reassure": "BBY0qq_reassure",
			"reassureOk": "BBY0qq_reassureOk",
			"repoLink": "BBY0qq_repoLink",
			"retryBtn": "BBY0qq_retryBtn",
			"root": "BBY0qq_root",
			"roster": "BBY0qq_roster",
			"rosterAuthor": "BBY0qq_rosterAuthor",
			"rosterMain": "BBY0qq_rosterMain",
			"rosterName": "BBY0qq_rosterName",
			"rosterRow": "BBY0qq_rosterRow",
			"rosterRowOut": "BBY0qq_rosterRowOut",
			"rosterSplit": "BBY0qq_rosterSplit",
			"rosterTag": "BBY0qq_rosterTag",
			"rosterTagDrop": "BBY0qq_rosterTagDrop",
			"rosterTagKeep": "BBY0qq_rosterTagKeep",
			"row1": "BBY0qq_row1",
			"sectAction": "BBY0qq_sectAction",
			"sectionOverview": "BBY0qq_sectionOverview",
			"setActions": "BBY0qq_setActions",
			"setBetaTag": "BBY0qq_setBetaTag",
			"setBody": "BBY0qq_setBody",
			"setCard": "BBY0qq_setCard",
			"setCardOpen": "BBY0qq_setCardOpen",
			"setCheck": "BBY0qq_setCheck",
			"setChevron": "BBY0qq_setChevron",
			"setChevronOpen": "BBY0qq_setChevronOpen",
			"setConfirm": "BBY0qq_setConfirm",
			"setDanger": "BBY0qq_setDanger",
			"setDesc": "BBY0qq_setDesc",
			"setHeader": "BBY0qq_setHeader",
			"setHeadText": "BBY0qq_setHeadText",
			"setHint": "BBY0qq_setHint",
			"setLabel": "BBY0qq_setLabel",
			"setLabelBox": "BBY0qq_setLabelBox",
			"setName": "BBY0qq_setName",
			"setRow": "BBY0qq_setRow",
			"setSeg": "BBY0qq_setSeg",
			"setSegBtn": "BBY0qq_setSegBtn",
			"setSegOn": "BBY0qq_setSegOn",
			"shot": "BBY0qq_shot",
			"shots": "BBY0qq_shots",
			"sp": "BBY0qq_sp",
			"spec": "BBY0qq_spec",
			"specTag": "BBY0qq_specTag",
			"specTagFile": "BBY0qq_specTagFile",
			"specTagGit": "BBY0qq_specTagGit",
			"spin": "BBY0qq_spin",
			"src": "BBY0qq_src",
			"staleAction": "BBY0qq_staleAction",
			"star": "BBY0qq_star",
			"stateDot": "BBY0qq_stateDot",
			"stateTag": "BBY0qq_stateTag",
			"stickyHead": "BBY0qq_stickyHead",
			"sub": "BBY0qq_sub",
			"submitLink": "BBY0qq_submitLink",
			"subTabs": "BBY0qq_subTabs",
			"swatches": "BBY0qq_swatches",
			"switch": "BBY0qq_switch",
			"switchKnob": "BBY0qq_switchKnob",
			"switchMixed": "BBY0qq_switchMixed",
			"switchOn": "BBY0qq_switchOn",
			"tab": "BBY0qq_tab",
			"tabs": "BBY0qq_tabs",
			"tabSearch": "BBY0qq_tabSearch",
			"tabSearchRow": "BBY0qq_tabSearchRow",
			"tag": "BBY0qq_tag",
			"themesGrid": "BBY0qq_themesGrid",
			"title": "BBY0qq_title",
			"titleRow": "BBY0qq_titleRow",
			"top": "BBY0qq_top",
			"topBtn": "BBY0qq_topBtn",
			"version": "BBY0qq_version",
			"viewBar": "BBY0qq_viewBar",
			"viewBtn": "BBY0qq_viewBtn",
			"viewOn": "BBY0qq_viewOn",
			"warnLine": "BBY0qq_warnLine"
		};
		//#endregion
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.cardHeadRight,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
										className: Market_module_css_default.cardRepoLink,
										href: p.url,
										target: "_blank",
										rel: "noreferrer",
										title: p.url,
