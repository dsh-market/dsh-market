window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/SearchInput.tsx
		/** Keep each tab's query in its parent, just like typing or deleting text. */
		function SearchInput({ value, onChange, placeholder, className, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: containerRef,
				className: `${Market_module_css_default.searchField} ${className}`,
