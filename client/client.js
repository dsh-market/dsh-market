window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".v6wesW_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.v6wesW_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.v6wesW_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.v6wesW_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.v6wesW_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.v6wesW_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.v6wesW_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.v6wesW_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.v6wesW_tab.v6wesW_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.v6wesW_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.v6wesW_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.v6wesW_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.v6wesW_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.v6wesW_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.v6wesW_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.v6wesW_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.v6wesW_cats{margin:0 -4px 2px;padding:12px 4px 4px}.v6wesW_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.v6wesW_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.v6wesW_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.v6wesW_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.v6wesW_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.v6wesW_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.v6wesW_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.v6wesW_catsCollapsed{max-height:62px;overflow:hidden}.v6wesW_catsToggle.v6wesW_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.v6wesW_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.v6wesW_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.v6wesW_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.v6wesW_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.v6wesW_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.v6wesW_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.v6wesW_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.v6wesW_lightboxClose:hover{background:#ffffff38}.v6wesW_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.v6wesW_lightboxNav:hover{background:#ffffff38}.v6wesW_lightboxPrev{left:16px}.v6wesW_lightboxNext{right:16px}.v6wesW_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.v6wesW_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.v6wesW_lightboxDotOn{background:#fff}.v6wesW_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.v6wesW_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.v6wesW_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.v6wesW_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.v6wesW_masonry{align-items:flex-start;gap:10px;display:flex}.v6wesW_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.v6wesW_masonry>.v6wesW_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.v6wesW_masonry{flex-direction:column}.v6wesW_masonryCol{width:100%}.v6wesW_grid{grid-template-columns:minmax(0,1fr)}}.v6wesW_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.v6wesW_themesGrid{margin-bottom:12px}.v6wesW_swatches i{flex:1}.v6wesW_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.v6wesW_themeSearch{box-sizing:border-box;width:100%;min-width:0}.v6wesW_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.v6wesW_themeFullscreenBtn.v6wesW_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.v6wesW_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.v6wesW_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.v6wesW_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.v6wesW_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.v6wesW_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.v6wesW_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.v6wesW_themeCover:hover img{transform:scale(1.012)}.v6wesW_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.v6wesW_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.v6wesW_themePreviewAction,.v6wesW_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.v6wesW_themePreviewAction{gap:4px;right:8px}.v6wesW_themePreviewCount{left:8px}.v6wesW_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.v6wesW_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.v6wesW_themeIdentity{flex:1;min-width:0}.v6wesW_themeStatus,.v6wesW_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.v6wesW_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.v6wesW_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.v6wesW_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.v6wesW_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.v6wesW_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.v6wesW_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.v6wesW_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.v6wesW_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.v6wesW_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.v6wesW_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.v6wesW_sub>span:first-child{grid-area:1/1}.v6wesW_sub>.v6wesW_grow{display:none}.v6wesW_submitLink{grid-area:2/1}.v6wesW_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.v6wesW_themeToolbar{grid-template-columns:minmax(0,1fr)}.v6wesW_themeCardHead{flex-wrap:wrap}.v6wesW_themeStatus,.v6wesW_themeStatusMuted{order:3}}@container (width<=280px){.v6wesW_themeCardFooter{flex-direction:column;align-items:flex-start}.v6wesW_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.v6wesW_themeCard,.v6wesW_themeCover img{transition:none}.v6wesW_themeCard:hover{transform:none}}.v6wesW_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.v6wesW_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.v6wesW_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.v6wesW_installBtn.v6wesW_installBtn{min-width:64px}.v6wesW_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.v6wesW_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.v6wesW_nmLink{color:inherit;text-decoration:none;display:block}.v6wesW_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.v6wesW_repoMark{color:var(--dsw-alias-label-tertiary,#8b93a1);vertical-align:-1px;flex-shrink:0;margin-left:5px}.v6wesW_nmLink:hover .v6wesW_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.v6wesW_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.v6wesW_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.v6wesW_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.v6wesW_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.v6wesW_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.v6wesW_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.v6wesW_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.v6wesW_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.v6wesW_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.v6wesW_foot .v6wesW_metaInline,.v6wesW_foot .v6wesW_src{white-space:nowrap}.v6wesW_grow{flex:1}.v6wesW_titleRow{align-items:center;gap:10px;display:flex}.v6wesW_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.v6wesW_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.v6wesW_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.v6wesW_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.v6wesW_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.v6wesW_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.v6wesW_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.v6wesW_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.v6wesW_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.v6wesW_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.v6wesW_noteInput{flex:1;min-width:160px}.v6wesW_descTight{min-height:0}.v6wesW_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.v6wesW_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.v6wesW_dot{vertical-align:2px;margin-left:5px}.v6wesW_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.v6wesW_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.v6wesW_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.v6wesW_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.v6wesW_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.v6wesW_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.v6wesW_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite v6wesW_sp;display:inline-flex}.v6wesW_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.v6wesW_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite v6wesW_dshmPlug}@keyframes v6wesW_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.v6wesW_logoPlug,.v6wesW_spin{animation:1.5s ease-in-out infinite v6wesW_dshmPlugFade}}@keyframes v6wesW_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes v6wesW_sp{to{transform:rotate(360deg)}}.v6wesW_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.v6wesW_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.v6wesW_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.v6wesW_barWave{width:30%;animation:1.2s ease-in-out infinite v6wesW_dshmSlide}@keyframes v6wesW_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.v6wesW_irow .v6wesW_progress{margin-top:8px}.v6wesW_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.v6wesW_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.v6wesW_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.v6wesW_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.v6wesW_conflictHead{align-items:flex-start;gap:8px;display:flex}.v6wesW_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.v6wesW_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.v6wesW_conflictBody{margin:0;font-size:12px;line-height:19px}.v6wesW_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.v6wesW_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.v6wesW_rosterMain{flex-direction:column;min-width:0;display:flex}.v6wesW_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.v6wesW_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.v6wesW_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.v6wesW_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.v6wesW_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.v6wesW_rosterRowOut .v6wesW_rosterName{text-decoration:line-through}.v6wesW_rosterRowOut{opacity:.62}.v6wesW_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.v6wesW_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.v6wesW_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.v6wesW_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.v6wesW_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.v6wesW_choices{flex-direction:column;gap:7px;display:flex}.v6wesW_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.v6wesW_choice:has(input:disabled){cursor:default;opacity:.6}.v6wesW_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.v6wesW_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.v6wesW_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.v6wesW_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.v6wesW_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.v6wesW_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.v6wesW_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.v6wesW_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.v6wesW_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.v6wesW_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.v6wesW_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.v6wesW_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.v6wesW_nameLink{color:inherit;text-decoration:none}.v6wesW_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.v6wesW_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.v6wesW_irowName>.v6wesW_owner{flex:none}.v6wesW_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.v6wesW_opWrap{flex-shrink:0;display:inline-flex;position:relative}.v6wesW_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.v6wesW_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.v6wesW_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.v6wesW_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.v6wesW_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.v6wesW_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.v6wesW_opPanelTitle{font-size:12.5px;font-weight:600}.v6wesW_opCloseBtn.v6wesW_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.v6wesW_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.v6wesW_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.v6wesW_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.v6wesW_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.v6wesW_opRow:last-child{border-bottom:none}.v6wesW_opRowAlert{background:#dc26260f}.v6wesW_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.v6wesW_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.v6wesW_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.v6wesW_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.v6wesW_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.v6wesW_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.v6wesW_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.v6wesW_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.v6wesW_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.v6wesW_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.v6wesW_opDecisionFoot{align-items:center;gap:8px;display:flex}.v6wesW_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.v6wesW_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.v6wesW_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.v6wesW_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.v6wesW_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.v6wesW_dangerBtn.v6wesW_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.v6wesW_dangerBtn.v6wesW_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.v6wesW_dangerArmed.v6wesW_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.v6wesW_retryBtn{margin-top:4px}.v6wesW_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.v6wesW_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.v6wesW_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.v6wesW_irowMissing{filter:grayscale();opacity:.5}.v6wesW_irow>.v6wesW_src,.v6wesW_irow>.v6wesW_owner,.v6wesW_irow button{white-space:nowrap;flex-shrink:0}.v6wesW_tabSearchRow{padding:0 4px 6px;display:flex}.v6wesW_tabSearch{width:100%}.v6wesW_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.v6wesW_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.v6wesW_specTagGit{color:#0b7285;background:#12a3c41f}.v6wesW_specTagFile{color:#b07d1b;background:#f0b42924}.v6wesW_backupCheckList .v6wesW_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.v6wesW_backupCheckList .v6wesW_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.v6wesW_staleAction{margin-top:8px}.v6wesW_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.v6wesW_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.v6wesW_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.v6wesW_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.v6wesW_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.v6wesW_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.v6wesW_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.v6wesW_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.v6wesW_deprecate .v6wesW_src{margin-left:8px}.v6wesW_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.v6wesW_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.v6wesW_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.v6wesW_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.v6wesW_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.v6wesW_switchOn .v6wesW_switchKnob,.v6wesW_switchMixed .v6wesW_switchKnob{left:18px}.v6wesW_switch:disabled{opacity:.5;cursor:default}.v6wesW_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.v6wesW_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.v6wesW_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.v6wesW_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.v6wesW_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.v6wesW_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.v6wesW_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.v6wesW_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.v6wesW_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.v6wesW_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.v6wesW_groupMember .v6wesW_nm{flex:1;min-width:0;font-size:12px}.v6wesW_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.v6wesW_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.v6wesW_inlineInput{flex:1;min-width:120px}.v6wesW_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.v6wesW_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.v6wesW_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.v6wesW_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.v6wesW_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.v6wesW_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.v6wesW_backupCard h3{margin:0;font-size:14px}.v6wesW_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.v6wesW_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.v6wesW_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.v6wesW_backupInput{box-sizing:border-box;width:100%}.v6wesW_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.v6wesW_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.v6wesW_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.v6wesW_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.v6wesW_backupCheckList .v6wesW_backupCheck{justify-content:space-between;gap:8px}.v6wesW_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.v6wesW_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.v6wesW_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.v6wesW_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.v6wesW_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.v6wesW_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.v6wesW_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.v6wesW_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.v6wesW_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.v6wesW_diagBundle:first-of-type{border-top:none;padding-top:0}.v6wesW_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.v6wesW_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.v6wesW_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.v6wesW_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.v6wesW_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.v6wesW_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.v6wesW_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.v6wesW_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.v6wesW_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.v6wesW_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.v6wesW_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.v6wesW_diagList{flex-direction:column;gap:6px;display:flex}.v6wesW_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.v6wesW_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.v6wesW_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.v6wesW_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.v6wesW_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.v6wesW_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.v6wesW_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.v6wesW_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.v6wesW_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.v6wesW_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.v6wesW_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.v6wesW_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.v6wesW_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.v6wesW_collapseTitle{flex:1;min-width:0}.v6wesW_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.v6wesW_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.v6wesW_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.v6wesW_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.v6wesW_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.v6wesW_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.v6wesW_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.v6wesW_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.v6wesW_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.v6wesW_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.v6wesW_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.v6wesW_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.v6wesW_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.v6wesW_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.v6wesW_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.v6wesW_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.v6wesW_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.v6wesW_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.v6wesW_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.v6wesW_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.v6wesW_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.v6wesW_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.v6wesW_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.v6wesW_setChevronOpen{transform:rotate(180deg)}.v6wesW_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.v6wesW_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.v6wesW_setRow+.v6wesW_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.v6wesW_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.v6wesW_setLabel{font-size:13px;line-height:20px}.v6wesW_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.v6wesW_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.v6wesW_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.v6wesW_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.v6wesW_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.v6wesW_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.v6wesW_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.v6wesW_setSegBtn:disabled{cursor:default;opacity:.5}.v6wesW_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.v6wesW_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.v6wesW_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}.v6wesW_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.v6wesW_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}.v6wesW_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}.v6wesW_commentsStatus:empty{display:none}.v6wesW_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}.v6wesW_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}.v6wesW_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}.v6wesW_commentsMount iframe{width:100%}.v6wesW_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}.v6wesW_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}.v6wesW_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}.v6wesW_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}.v6wesW_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}.v6wesW_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}.v6wesW_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.v6wesW_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}.v6wesW_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}.v6wesW_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}.v6wesW_notesP{font-size:13px;line-height:20px}.v6wesW_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}.v6wesW_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}.v6wesW_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}.v6wesW_notesRow:last-child{border-bottom:none}.v6wesW_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}.v6wesW_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}.v6wesW_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}.v6wesW_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}.v6wesW_notesVer{color:inherit;font-weight:600;text-decoration:none}.v6wesW_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "v6wesW_act",
			"actBroken": "v6wesW_actBroken",
			"actLive": "v6wesW_actLive",
			"actWarn": "v6wesW_actWarn",
			"actWhy": "v6wesW_actWhy",
			"assignRow": "v6wesW_assignRow",
			"assignSelect": "v6wesW_assignSelect",
			"av": "v6wesW_av",
			"backupActions": "v6wesW_backupActions",
			"backupCard": "v6wesW_backupCard",
			"backupCheck": "v6wesW_backupCheck",
			"backupCheckList": "v6wesW_backupCheckList",
			"backupGrid": "v6wesW_backupGrid",
			"backupInput": "v6wesW_backupInput",
			"backupMessage": "v6wesW_backupMessage",
			"backupWarn": "v6wesW_backupWarn",
			"banner": "v6wesW_banner",
			"bannerHint": "v6wesW_bannerHint",
			"bannerIcon": "v6wesW_bannerIcon",
			"bar": "v6wesW_bar",
			"barFill": "v6wesW_barFill",
			"barWave": "v6wesW_barWave",
			"body": "v6wesW_body",
			"byline": "v6wesW_byline",
			"card": "v6wesW_card",
			"cardAction": "v6wesW_cardAction",
			"cardBlocked": "v6wesW_cardBlocked",
			"cardBlockedMark": "v6wesW_cardBlockedMark",
			"cardShot": "v6wesW_cardShot",
			"cardShots": "v6wesW_cardShots",
			"cats": "v6wesW_cats",
			"catsCollapsed": "v6wesW_catsCollapsed",
			"catsRow": "v6wesW_catsRow",
			"catsToggle": "v6wesW_catsToggle",
			"catsWrap": "v6wesW_catsWrap",
			"choice": "v6wesW_choice",
			"choiceMain": "v6wesW_choiceMain",
			"choiceNote": "v6wesW_choiceNote",
			"choiceOn": "v6wesW_choiceOn",
			"choiceRadio": "v6wesW_choiceRadio",
			"choices": "v6wesW_choices",
			"choiceSafe": "v6wesW_choiceSafe",
			"choiceTitle": "v6wesW_choiceTitle",
			"cmd": "v6wesW_cmd",
			"collapseBody": "v6wesW_collapseBody",
			"collapseHead": "v6wesW_collapseHead",
			"collapseIcon": "v6wesW_collapseIcon",
			"collapseTitle": "v6wesW_collapseTitle",
			"commentsError": "v6wesW_commentsError",
			"commentsFail": "v6wesW_commentsFail",
			"commentsLink": "v6wesW_commentsLink",
			"commentsMount": "v6wesW_commentsMount",
			"commentsNote": "v6wesW_commentsNote",
			"commentsStatus": "v6wesW_commentsStatus",
			"confirmRow": "v6wesW_confirmRow",
			"conflictBody": "v6wesW_conflictBody",
			"conflictDetailsToggle": "v6wesW_conflictDetailsToggle",
			"conflictHead": "v6wesW_conflictHead",
			"conflictIcon": "v6wesW_conflictIcon",
			"conflictTitle": "v6wesW_conflictTitle",
			"conflictWhy": "v6wesW_conflictWhy",
			"conflictWhyText": "v6wesW_conflictWhyText",
			"dangerArmed": "v6wesW_dangerArmed",
			"dangerBtn": "v6wesW_dangerBtn",
			"depBadge": "v6wesW_depBadge",
			"depLine": "v6wesW_depLine",
			"deprecate": "v6wesW_deprecate",
			"desc": "v6wesW_desc",
			"descClamp": "v6wesW_descClamp",
			"descTight": "v6wesW_descTight",
			"descToggle": "v6wesW_descToggle",
			"diagAlert": "v6wesW_diagAlert",
			"diagArrow": "v6wesW_diagArrow",
			"diagBadgeCommunity": "v6wesW_diagBadgeCommunity",
			"diagBadgeInfo": "v6wesW_diagBadgeInfo",
			"diagBadgeOfficial": "v6wesW_diagBadgeOfficial",
			"diagBadgeShadow": "v6wesW_diagBadgeShadow",
			"diagBadgeWarn": "v6wesW_diagBadgeWarn",
			"diagBundle": "v6wesW_diagBundle",
			"diagCount": "v6wesW_diagCount",
			"diagEmpty": "v6wesW_diagEmpty",
			"diagIndex": "v6wesW_diagIndex",
			"diagKey": "v6wesW_diagKey",
			"diagList": "v6wesW_diagList",
			"diagMeta": "v6wesW_diagMeta",
			"diagPage": "v6wesW_diagPage",
			"diagRow": "v6wesW_diagRow",
			"diagSection": "v6wesW_diagSection",
			"diagSummary": "v6wesW_diagSummary",
			"diagSummaryItem": "v6wesW_diagSummaryItem",
			"diagSummaryMeta": "v6wesW_diagSummaryMeta",
			"diagVal": "v6wesW_diagVal",
			"dot": "v6wesW_dot",
			"dragging": "v6wesW_dragging",
			"dragHandle": "v6wesW_dragHandle",
			"dragOver": "v6wesW_dragOver",
			"dshmPlug": "v6wesW_dshmPlug",
			"dshmPlugFade": "v6wesW_dshmPlugFade",
			"dshmSlide": "v6wesW_dshmSlide",
			"empty": "v6wesW_empty",
			"err": "v6wesW_err",
			"exportLogBtn": "v6wesW_exportLogBtn",
			"fixFallback": "v6wesW_fixFallback",
			"fixFallbackText": "v6wesW_fixFallbackText",
			"foot": "v6wesW_foot",
			"grid": "v6wesW_grid",
			"groupActions": "v6wesW_groupActions",
			"groupAddPanel": "v6wesW_groupAddPanel",
			"groupCreate": "v6wesW_groupCreate",
			"groupHead": "v6wesW_groupHead",
			"groupHint": "v6wesW_groupHint",
			"groupMember": "v6wesW_groupMember",
			"groupMembers": "v6wesW_groupMembers",
			"groupName": "v6wesW_groupName",
			"groupRow": "v6wesW_groupRow",
			"grow": "v6wesW_grow",
			"head": "v6wesW_head",
			"hiddenFile": "v6wesW_hiddenFile",
			"inlineInput": "v6wesW_inlineInput",
			"installBtn": "v6wesW_installBtn",
			"irow": "v6wesW_irow",
			"irowActions": "v6wesW_irowActions",
			"irowMissing": "v6wesW_irowMissing",
			"irowName": "v6wesW_irowName",
			"irowNameText": "v6wesW_irowNameText",
			"irowTrailing": "v6wesW_irowTrailing",
			"lightbox": "v6wesW_lightbox",
			"lightboxClose": "v6wesW_lightboxClose",
			"lightboxDot": "v6wesW_lightboxDot",
			"lightboxDotOn": "v6wesW_lightboxDotOn",
			"lightboxDots": "v6wesW_lightboxDots",
			"lightboxImg": "v6wesW_lightboxImg",
			"lightboxNav": "v6wesW_lightboxNav",
			"lightboxNext": "v6wesW_lightboxNext",
			"lightboxPrev": "v6wesW_lightboxPrev",
			"loading": "v6wesW_loading",
			"logoMark": "v6wesW_logoMark",
			"logoPlug": "v6wesW_logoPlug",
			"masonry": "v6wesW_masonry",
			"masonryCol": "v6wesW_masonryCol",
			"meta": "v6wesW_meta",
			"metaInline": "v6wesW_metaInline",
			"metaTag": "v6wesW_metaTag",
			"metaTagOk": "v6wesW_metaTagOk",
			"modalNote": "v6wesW_modalNote",
			"nameLink": "v6wesW_nameLink",
			"nm": "v6wesW_nm",
			"nmLink": "v6wesW_nmLink",
			"noteAction": "v6wesW_noteAction",
			"noteEdit": "v6wesW_noteEdit",
			"noteInput": "v6wesW_noteInput",
			"noteMine": "v6wesW_noteMine",
			"noteRow": "v6wesW_noteRow",
			"notesArrow": "v6wesW_notesArrow",
			"notesBody": "v6wesW_notesBody",
			"notesCode": "v6wesW_notesCode",
			"notesDate": "v6wesW_notesDate",
			"notesH": "v6wesW_notesH",
			"notesLink": "v6wesW_notesLink",
			"notesList": "v6wesW_notesList",
			"notesMeta": "v6wesW_notesMeta",
			"notesMsg": "v6wesW_notesMsg",
			"notesP": "v6wesW_notesP",
			"notesPre": "v6wesW_notesPre",
			"notesRange": "v6wesW_notesRange",
			"notesRendered": "v6wesW_notesRendered",
			"notesRow": "v6wesW_notesRow",
			"notesSha": "v6wesW_notesSha",
			"notesVer": "v6wesW_notesVer",
			"noteToggle": "v6wesW_noteToggle",
			"okState": "v6wesW_okState",
			"on": "v6wesW_on",
			"opActions": "v6wesW_opActions",
			"opAggregate": "v6wesW_opAggregate",
			"opAggregateHint": "v6wesW_opAggregateHint",
			"opAggregateTop": "v6wesW_opAggregateTop",
			"opCloseBtn": "v6wesW_opCloseBtn",
			"opDecision": "v6wesW_opDecision",
			"opDecisionFoot": "v6wesW_opDecisionFoot",
			"opDot": "v6wesW_opDot",
			"opEmpty": "v6wesW_opEmpty",
			"opEmptyHint": "v6wesW_opEmptyHint",
			"opEntry": "v6wesW_opEntry",
			"opEntryAlert": "v6wesW_opEntryAlert",
			"opEntryQuiet": "v6wesW_opEntryQuiet",
			"opHead": "v6wesW_opHead",
			"opIcon": "v6wesW_opIcon",
			"opMain": "v6wesW_opMain",
			"opName": "v6wesW_opName",
			"opPanel": "v6wesW_opPanel",
			"opPanelTitle": "v6wesW_opPanelTitle",
			"opQueuedIcon": "v6wesW_opQueuedIcon",
			"opRow": "v6wesW_opRow",
			"opRowAlert": "v6wesW_opRowAlert",
			"opStatus": "v6wesW_opStatus",
			"opStatusBad": "v6wesW_opStatusBad",
			"opTop": "v6wesW_opTop",
			"opVerb": "v6wesW_opVerb",
			"opWrap": "v6wesW_opWrap",
			"orderPanel": "v6wesW_orderPanel",
			"orphBadge": "v6wesW_orphBadge",
			"orphRow": "v6wesW_orphRow",
			"ovArrow": "v6wesW_ovArrow",
			"ovByTag": "v6wesW_ovByTag",
			"ovFrom": "v6wesW_ovFrom",
			"ovRow": "v6wesW_ovRow",
			"owner": "v6wesW_owner",
			"pageEllipsis": "v6wesW_pageEllipsis",
			"pageInfo": "v6wesW_pageInfo",
			"pager": "v6wesW_pager",
			"pagerPages": "v6wesW_pagerPages",
			"panelActions": "v6wesW_panelActions",
			"panelNote": "v6wesW_panelNote",
			"pct": "v6wesW_pct",
			"presetList": "v6wesW_presetList",
			"presetName": "v6wesW_presetName",
			"presetRow": "v6wesW_presetRow",
			"progress": "v6wesW_progress",
			"reassure": "v6wesW_reassure",
			"reassureOk": "v6wesW_reassureOk",
			"repoLink": "v6wesW_repoLink",
			"repoMark": "v6wesW_repoMark",
			"retryBtn": "v6wesW_retryBtn",
			"root": "v6wesW_root",
			"roster": "v6wesW_roster",
			"rosterAuthor": "v6wesW_rosterAuthor",
			"rosterMain": "v6wesW_rosterMain",
			"rosterName": "v6wesW_rosterName",
			"rosterRow": "v6wesW_rosterRow",
			"rosterRowOut": "v6wesW_rosterRowOut",
			"rosterSplit": "v6wesW_rosterSplit",
			"rosterTag": "v6wesW_rosterTag",
			"rosterTagDrop": "v6wesW_rosterTagDrop",
			"rosterTagKeep": "v6wesW_rosterTagKeep",
			"row1": "v6wesW_row1",
			"sectAction": "v6wesW_sectAction",
			"sectionOverview": "v6wesW_sectionOverview",
			"setActions": "v6wesW_setActions",
			"setBetaTag": "v6wesW_setBetaTag",
			"setBody": "v6wesW_setBody",
			"setCard": "v6wesW_setCard",
			"setCardOpen": "v6wesW_setCardOpen",
			"setCheck": "v6wesW_setCheck",
			"setChevron": "v6wesW_setChevron",
			"setChevronOpen": "v6wesW_setChevronOpen",
			"setConfirm": "v6wesW_setConfirm",
			"setDanger": "v6wesW_setDanger",
			"setDesc": "v6wesW_setDesc",
			"setHeader": "v6wesW_setHeader",
			"setHeadText": "v6wesW_setHeadText",
			"setHint": "v6wesW_setHint",
			"setLabel": "v6wesW_setLabel",
			"setLabelBox": "v6wesW_setLabelBox",
			"setName": "v6wesW_setName",
			"setRow": "v6wesW_setRow",
			"setSeg": "v6wesW_setSeg",
			"setSegBtn": "v6wesW_setSegBtn",
			"setSegOn": "v6wesW_setSegOn",
			"shot": "v6wesW_shot",
			"shots": "v6wesW_shots",
			"snapConfirmText": "v6wesW_snapConfirmText",
			"snapList": "v6wesW_snapList",
			"snapMeta": "v6wesW_snapMeta",
			"snapRow": "v6wesW_snapRow",
			"sp": "v6wesW_sp",
			"spec": "v6wesW_spec",
			"specTag": "v6wesW_specTag",
			"specTagFile": "v6wesW_specTagFile",
			"specTagGit": "v6wesW_specTagGit",
			"spin": "v6wesW_spin",
			"src": "v6wesW_src",
			"staleAction": "v6wesW_staleAction",
			"star": "v6wesW_star",
			"stateDot": "v6wesW_stateDot",
			"stateTag": "v6wesW_stateTag",
			"stickyHead": "v6wesW_stickyHead",
			"sub": "v6wesW_sub",
			"submitLink": "v6wesW_submitLink",
			"subTabs": "v6wesW_subTabs",
			"swatches": "v6wesW_swatches",
			"switch": "v6wesW_switch",
			"switchKnob": "v6wesW_switchKnob",
			"switchMixed": "v6wesW_switchMixed",
			"switchOn": "v6wesW_switchOn",
			"tab": "v6wesW_tab",
			"tabs": "v6wesW_tabs",
			"tabSearch": "v6wesW_tabSearch",
			"tabSearchRow": "v6wesW_tabSearchRow",
			"tag": "v6wesW_tag",
			"themeActions": "v6wesW_themeActions",
			"themeCard": "v6wesW_themeCard",
			"themeCardBody": "v6wesW_themeCardBody",
			"themeCardFooter": "v6wesW_themeCardFooter",
			"themeCardHead": "v6wesW_themeCardHead",
			"themeCover": "v6wesW_themeCover",
			"themeCoverEmpty": "v6wesW_themeCoverEmpty",
			"themeDescription": "v6wesW_themeDescription",
			"themeFullscreenBtn": "v6wesW_themeFullscreenBtn",
			"themeGallery": "v6wesW_themeGallery",
			"themeIdentity": "v6wesW_themeIdentity",
			"themeLifecycle": "v6wesW_themeLifecycle",
			"themePreviewAction": "v6wesW_themePreviewAction",
			"themePreviewCount": "v6wesW_themePreviewCount",
			"themeResultBar": "v6wesW_themeResultBar",
			"themeSearch": "v6wesW_themeSearch",
			"themesGrid": "v6wesW_themesGrid",
			"themeStatus": "v6wesW_themeStatus",
			"themeStatusMuted": "v6wesW_themeStatusMuted",
			"themeToolbar": "v6wesW_themeToolbar",
			"themeToolbarActions": "v6wesW_themeToolbarActions",
			"title": "v6wesW_title",
			"titleRow": "v6wesW_titleRow",
			"top": "v6wesW_top",
			"topBtn": "v6wesW_topBtn",
			"version": "v6wesW_version",
			"viewBar": "v6wesW_viewBar",
			"viewBtn": "v6wesW_viewBtn",
			"viewOn": "v6wesW_viewOn",
			"warnLine": "v6wesW_warnLine"
		};
		//#endregion
