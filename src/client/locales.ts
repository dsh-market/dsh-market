...
export const zh = {
  ...
  migrateHint: '这是来源变更，不是普通更新：{0} → {1}。npm 包可能由不同发布者维护；仅在确认该目录映射可信时继续。',
  migrateFail: '来源迁移失败',
  restore: '恢复',
...
export const en: Record<MarketKey, string> = {
  ...
  migrateHint: 'This changes source, not just version: {0} → {1}. The npm package may be maintained by a different publisher; continue only if you trust this catalog mapping.',
