 ...
 *
 * `logChange` is false for a scratch write — the toggle stages and validates
 * its rows on a copy first (#582), and a log line claiming a row was written
 * before anything was published is worse than no line at all.
 */
